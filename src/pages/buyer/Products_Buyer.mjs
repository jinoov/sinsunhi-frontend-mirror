  ...
  if (products$p.TAG === /* Ok */0) {
    ...
    tmp = React$1.createElement("ol", {
          className: "divide-y divide-gray-300 lg:divide-gray-100 lg:list-height-buyer lg:overflow-y-scroll"
                  ...
                  return React.createElementWithKey(Product_Buyer.make, {
                              product: product
                            }, product.productSku);
                })) : React$1.createElement(EmptyProducts.make, {}));
  } else {
    tmp = React$1.createElement(EmptyProducts.make, {});
  }
  var tmp$1;
...
function Products_Buyer$Products(props) {
  ...
  return React$1.createElement("div", {
            ...
            }, React$1.createElement(Search_Product_Buyer.make, {}), React$1.createElement("div", {
                          ...
                          className: "pt-10 px-5 flex flex-col lg:flex-row sm:flex-auto sm:justify-between"
                              ...
                              className: "flex flex-col lg:flex-row mt-4 lg:mt-0"
                                  ...
                                  className: "flex mt-2 lg:mt-0"
                                    ...
                                    }))))), React$1.createElement(Products_Buyer$List, {
                      status: status
                    })));
}
...
function Products_Buyer(props) {
  return React$1.createElement(Authorization.Buyer.make, {
              children: React$1.createElement(Products_Buyer$Products, {}),
              title: "상품"
            });
}
