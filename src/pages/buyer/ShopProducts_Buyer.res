...
module Fragment = %relay(`
  fragment ShopProductsBuyerFragment on DisplayCategory
  @refetchable(queryName: "ShopProductsBuyerRefetchQuery")
  @argumentDefinitions(
    ...
    products(
      ...
      sort: $sort
      onlyBuyable: $onlyBuyable
    ) @connection(key: "ShopProductsBuyer_products") {
      edges {
        cursor
        node {
  ...
  <>
    ...
    <RescriptReactErrorBoundary fallback={_ => <Placeholder />}>
      <React.Suspense fallback={<Placeholder />}>
        ...
        | Some(displayCategoryId') => <Container displayCategoryId=displayCategoryId' sort />
        | None => <Placeholder />
        }}
      </React.Suspense>
