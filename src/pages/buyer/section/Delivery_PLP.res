module Query = %relay(`
  query DeliveryPLPGetCategoryNameQuery($displayCategoryId: ID!) {
  ...
  module View = {
    ...
    let make = (~categoryName, ~subCategoryName) => {
      <>
        ...
        <Delivery_PLP_Category.PC categoryName />
        <Delivery_PLP_ProductList.PC subCategoryName />
      </>
    }
  }
  module Skeleton = {
...
module MO = {
  module View = {
    ...
    let make = (~categoryName, ~subCategoryName) => {
      <>
        <Delivery_PLP_Category.MO categoryName /> <Delivery_PLP_ProductList.MO subCategoryName />
      </>
    }
  }
  module Skeleton = {
    ...
    let make = () => {
      <div className=%twc("w-full")>
        <Delivery_PLP_Category.MO.Skeleton />
