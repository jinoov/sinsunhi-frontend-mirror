  ...
  return React$1.createElement("div", {
              className: "w-[1280px] mx-auto mt-20"
                  ...
                  className: "w-full flex overflow-hidden gap-[78px] overflow-x-scroll scrollbar-hide"
                        ...
                        var id = param.id;
                        return React.createElementWithKey(Matching_Main_Category$ListItem$PC, {
                                    id: id,
                                    src: param.src,
                                    name: param.name
              ...
              className: "w-[1280px] mx-auto mt-20 overflow-hidden overflow-x-scroll scrollbar-hide"
                  ...
                  className: "w-full flex items-center "
                      ...
                      15
                        ...
                        return React.createElementWithKey(Matching_Main_Category$ListItem$PC$Skeleton, {}, key);
                      }))));
}
...
function Matching_Main_Category$PC(props) {
  ...
  return React$1.createElement(Matching_Main_Category$PC$View, {
              title: "카테고리",
              items: items
            });
}
  ...
  return React$1.createElement("div", {
              className: "w-full flex flex-col mb-5"
                  ...
                  className: "w-full flex gap-2 overflow-x-scroll  scrollbar-hide"
                        ...
                        var id = param.id;
                        return React.createElementWithKey(Matching_Main_Category$ListItem$MO, {
                                    id: id,
                                    src: param.src,
                                    name: param.name
              ...
              className: "w-full flex flex-col mb-5"
                  ...
                  className: "mt-6 w-full flex gap-2 overflow-x-scroll scrollbar-hide"
                      ...
                      7
                        ...
                        var key = "matching-main-category-placeholder-" + String(index) + "";
                        return React.createElementWithKey(Matching_Main_Category$ListItem$MO$Skeleton, {}, key);
                      }))));
}
...
function Matching_Main_Category$MO(props) {
  ...
  return React$1.createElement(Matching_Main_Category$MO$View, {
              title: "카테고리",
              items: items
            });
}
