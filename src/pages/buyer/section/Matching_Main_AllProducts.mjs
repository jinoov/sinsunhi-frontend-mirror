...
function Matching_Main_AllProducts$PC$Container(props) {
  ...
  return React$1.createElement(Matching_Main_AllProducts$PC$View, {
...
function Matching_Main_AllProducts$PC(props) {
  ...
  return React$1.createElement(RescriptReactErrorBoundary.make, {
              children: React$1.createElement(React$1.Suspense, {
                    children: Caml_option.some(React$1.createElement(Matching_Main_AllProducts$PC$Container, {})),
                    fallback: Caml_option.some(React$1.createElement(Matching_Main_AllProducts$PC$Skeleton, {}))
                  }),
              fallback: (function (param) {
                  return React$1.createElement(Matching_Main_AllProducts$PC$Skeleton, {});
                })
            });
}
...
function Matching_Main_AllProducts$MO$View(props) {
  ...
  if (products.edges.length === 0) {
    return React$1.createElement(Matching_Main_AllProducts$MO$Empty, {});
  } else {
    return React$1.createElement("div", {
                className: "w-full pt-1 px-5"
                    ...
                    className: "mb-4 w-full flex items-center justify-between text-gray-800"
                        ...
                        className: "font-bold"
                      }, "전체 신선매칭 상품"), React$1.createElement(MatchingSortSelect.MO.make, {})), React$1.createElement("ol", {
                    className: "grid grid-cols-2 gap-x-4 gap-y-8"
...
function Matching_Main_AllProducts$MO$Container(props) {
  ...
  return React$1.createElement(Matching_Main_AllProducts$MO$View, {
              query: match.fragmentRefs
            });
}
...
function Matching_Main_AllProducts$MO(props) {
  ...
  return React$1.createElement(RescriptReactErrorBoundary.make, {
              children: React$1.createElement(React$1.Suspense, {
                    children: Caml_option.some(React$1.createElement(Matching_Main_AllProducts$MO$Container, {})),
                    fallback: Caml_option.some(React$1.createElement(Matching_Main_AllProducts$MO$Skeleton, {}))
                  }),
              fallback: (function (param) {
                  return React$1.createElement(Matching_Main_AllProducts$MO$Skeleton, {});
                })
            });
}
