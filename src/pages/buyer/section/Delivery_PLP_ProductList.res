module Query = %relay(`
  query DeliveryPLPProductListQuery(
    ...
    node(id: $displayCategoryId) {
      ... on DisplayCategory {
        name
        ...DeliveryPLPProductListFragment
          @arguments(
            count: $count
            cursor: $cursor
            sort: $sort
...
module Fragment = %relay(`
  fragment DeliveryPLPProductListFragment on DisplayCategory
  @refetchable(queryName: "DeliveryPLPProductListRefetchQuery")
  @argumentDefinitions(
