...
function Delivery_PLP_ProductList$PC$Container(props) {
  ...
  var node = match.node;
  if (node !== undefined) {
    return React$1.createElement(Delivery_PLP_ProductList$PC$View, {
                query: node.fragmentRefs,
                subCategoryName: subCategoryName
              });
  } else {
    return React$1.createElement(Delivery_PLP_ProductList$PC$Empty, {
                subCategoryName: subCategoryName
              });
  }
}
...
function Delivery_PLP_ProductList$PC(props) {
  ...
  return React$1.createElement(RescriptReactErrorBoundary.make, {
              children: React$1.createElement(React$1.Suspense, {
                    children: Caml_option.some(React$1.createElement(Delivery_PLP_ProductList$PC$Container, {
                              subCategoryName: props.subCategoryName
                            })),
                    fallback: Caml_option.some(React$1.createElement(Delivery_PLP_ProductList$PC$Skeleton, {}))
                  }),
              fallback: (function (param) {
                  return React$1.createElement(Delivery_PLP_ProductList$PC$Skeleton, {});
                })
            });
}
...
function Delivery_PLP_ProductList$MO$View(props) {
  ...
  if (products.edges.length === 0) {
    return React$1.createElement(Delivery_PLP_ProductList$MO$Empty, {});
  } else {
    return React$1.createElement("div", {
                className: "w-full pt-1 px-5"
                    ...
                    className: "mt-6 mb-4 w-full flex items-center justify-between text-gray-800"
                        ...
                        className: "font-bold"
                      }, "" + props.subCategoryName + " 상품"), React$1.createElement(DeliverySortSelect.MO.make, {})), React$1.createElement("ol", {
                    className: "grid grid-cols-2 gap-x-4 gap-y-8"
...
function Delivery_PLP_ProductList$MO$Container(props) {
  ...
  var node = match.node;
  if (node !== undefined) {
    return React$1.createElement(Delivery_PLP_ProductList$MO$View, {
                query: node.fragmentRefs,
                subCategoryName: props.subCategoryName
              });
  } else {
...
function Delivery_PLP_ProductList$MO(props) {
  ...
  return React$1.createElement(RescriptReactErrorBoundary.make, {
              children: React$1.createElement(React$1.Suspense, {
                    children: Caml_option.some(React$1.createElement(Delivery_PLP_ProductList$MO$Container, {
                              subCategoryName: props.subCategoryName
                            })),
                    fallback: Caml_option.some(React$1.createElement(Delivery_PLP_ProductList$MO$Skeleton, {}))
                  }),
              fallback: (function (param) {
                  return React$1.createElement(Delivery_PLP_ProductList$MO$Skeleton, {});
                })
            });
}
