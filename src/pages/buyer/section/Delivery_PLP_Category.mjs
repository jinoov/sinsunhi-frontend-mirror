  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                  className: "h-11 px-5 scrollbar-hide"
                      ...
                      className: "flex gap-4 h-full"
                            ...
                            return React.createElementWithKey(Delivery_PLP_Category$ListItem$PC$Skeleton, {}, String(idx));
...
function Delivery_PLP_Category$PC(props) {
  ...
  return React$1.createElement(React$1.Suspense, {
              children: Caml_option.some(React$1.createElement(Delivery_PLP_Category$PC$View, {
                        items: items
                      })),
              fallback: Caml_option.some(React$1.createElement(Delivery_PLP_Category$PC$Skeleton, {}))
            });
}
...
function Delivery_PLP_Category$MO(props) {
  ...
  return React$1.createElement(React$1.Suspense, {
              children: Caml_option.some(React$1.createElement(Delivery_PLP_Category$MO$View, {
                        items: items
                      })),
              fallback: Caml_option.some(React$1.createElement(Delivery_PLP_Category$MO$Skeleton, {}))
            });
}
