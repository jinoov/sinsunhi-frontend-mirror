...
var Query_wosOrderStatus_decode = WebOrderCompleteBuyerQuery_graphql.Utils.wosOrderStatus_decode;

var Query_wosOrderStatus_fromString = WebOrderCompleteBuyerQuery_graphql.Utils.wosOrderStatus_fromString;
...
function toItems(index, param) {
  return item_encode({
              itemId: String(param.product.number),
              itemName: param.productName,
              currency: "KRW",
              itemVariant: param.productOption.stockSku,
              price: param.price,
...
function Web_Order_Complete_Buyer$PC(Props) {
  ...
  var isDepositPending = Props.isDepositPending;
  var deviceType = Props.deviceType;
                  ...
                  className: "flex flex-row gap-5"
                      ...
                      className: "w-3/5 flex flex-col gap-5 min-w-[550px]"
                          ...
                          className: "flex justify-center bg-white rounded-sm p-0"
                            ...
                            }, isDepositPending ? "주문이 신청되었습니다. 입금 완료 후 주문이 진행됩니다." : "총 " + String(numberOfProductOptions) + "건의 상품 주문이 완료되었습니다 📦")), React.createElement("section", {
                          className: "flex flex-col p-7 gap-7 bg-white rounded-sm min-w-max"
                  ...
                  className: "flex flex-col gap-4"
                      ...
                      className: "w-full flex flex-col gap-5"
                          ...
                          className: "flex justify-center bg-white rounded-sm p-7 min-w-[375px]"
                              ...
                              className: "w-full text-center text-base p-6 font-bold text-text-L1 shadow-card-box whitespace-pre-line"
                            }, isDepositPending ? "주문이 신청되었습니다.\n입금 완료 후 주문이 진행됩니다." : "총 " + String(numberOfProductOptions) + "건의 상품 주문이 완료되었습니다 📦")), React.createElement("section", {
                          className: "flex flex-col p-7 gap-7 bg-white rounded-sm min-w-max"
                        }, React.createElement(Web_Order_Complete_Product_Info_Buyer.make, {
                              query: query,
                              deviceType: deviceType
...
function Web_Order_Complete_Buyer$Container(Props) {
  ...
  React.useEffect((function () {
          ...
          Belt_Option.forEach(wosOrder, (function (wosOrder$p) {
                  ...
                  var match$2 = Belt_Option.flatMap(wosOrder$p.payment, (function (p) {
          ...
          Belt_Option.forEach(wosOrder, (function (wosOrder) {
                  Curry._3(Global.$$Window.ReactNativeWebView.PostMessage.airbridgeWithPayload, "PURCHASE", {
                        ...
                        products: Belt_Array.mapWithIndex(Garter_Array.keepSome(wosOrder.orderProducts), (function (i, product) {
                                return {
                                        ID: String(product.product.number),
  ...
  var match$1 = Belt_Option.mapWithDefault(wosOrder, [
        0,
        false
      ], (function (w) {
          return [
                  Belt_Array.keepMap(w.orderProducts, Garter_Fn.identity).length,
                  w.status === "DEPOSIT_PENDING"
                ];
        }));
  var isDepositPending = match$1[1];
  var numberOfProductOptions = match$1[0];
  switch (deviceType) {
    case /* Unknown */0 :
        return null;
    case /* PC */1 :
...
function $$default(props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Head, {
                  children: React.createElement("title", undefined, "신선하이 | 주문완료")
