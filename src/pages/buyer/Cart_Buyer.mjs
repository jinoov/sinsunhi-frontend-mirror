...
function Cart_Buyer$Container(props) {
  ...
  switch (deviceType) {
    case /* Unknown */0 :
        ...
        break;
    case /* PC */1 :
        tmp = React$1.createElement(React$1.Fragment, undefined, React.createElementWithKey(Header_Buyer.PC_Old.make, {}, router.asPath), React$1.createElement(Cart_Buyer_Item.make, {
                  query: query.fragmentRefs,
                  deviceType: deviceType
                }), React$1.createElement(Footer_Buyer.PC.make, {}));
        break;
    case /* Mobile */2 :
        tmp = React$1.createElement(React$1.Fragment, undefined, React$1.createElement(Header_Buyer.Mobile.make, {}), React$1.createElement(Cart_Buyer_Item.make, {
                  query: query.fragmentRefs,
                  deviceType: deviceType
                }));
        break;
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement(ReactHookForm.Provider.make, {
                  children: React$1.createElement("form", {
                        onSubmit: methods.handleSubmit(onSubmit)
                      }, tmp),
                  methods: methods
                }), React$1.createElement(Cart_Buyer_Util.SubmitDialog.make, {
                  _open: match$1[0],
                  setOpen: match$1[1]
                }));
}
...
function $$default(props) {
  ...
  return React$1.createElement(Authorization.Buyer.make, {
              children: React$1.createElement(React$1.Suspense, {
                    children: Caml_option.some(React$1.createElement(Cart_Buyer$Container, {
                              deviceType: deviceType
                            })),
                    fallback: Caml_option.some(React$1.createElement(Cart_Buyer_Item.PlaceHolder.make, {
                              deviceType: deviceType
                            }))
                  }),
              title: "장바구니",
