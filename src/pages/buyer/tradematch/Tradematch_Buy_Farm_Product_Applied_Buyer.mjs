...
function Tradematch_Buy_Farm_Product_Applied_Buyer(Props) {
  var router = Router.useRouter();
  React.useEffect((function () {
          Braze.PushNotificationRequestDialog.trigger(undefined);
        }), []);
  return React.createElement(React.Fragment, undefined, React.createElement(Tradematch_Buy_Farm_Apply_Steps_Buyer.Common.Title.make, {
                  text: "24시간 안으로 담당자가\n연락을 드릴예정입니다",
...
var make = Tradematch_Buy_Farm_Product_Applied_Buyer;
