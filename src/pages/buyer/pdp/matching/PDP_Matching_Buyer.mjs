              ...
              className: "w-full min-h-screen"
                  ...
                  className: "w-full bg-white"
                      ...
                      className: "w-full max-w-3xl mx-auto relative bg-white min-h-screen"
                          ...
                          className: "px-4"
                        }, React.createElement(PDP_Matching_Title_Buyer.MO.make, {
                              query: fragmentRefs,
                          ...
                          className: "py-6"
                        }, React.createElement(PDP_Matching_Demeter_Buyer.make, {
                              query: fragmentRefs,
                              selectedGroup: selectedGroup
                            })), React.createElement(PDP_Matching_Buyer$MO$Divider, {}), React.createElement(PDP_Matching_Estimator_Buyer.make, {
                          selectedGroup: selectedGroup,
                          query: fragmentRefs,
                          key: String(match.productId)
                        }), React.createElement("section", {
                          className: "px-4"
                          ...
                          className: "px-4 pt-4 pb-16"
                        }, React.createElement(PDP_Matching_ServiceGuide_Buyer.Trigger.make, {
                            ...
                            }), React.createElement(PDP_Matching_GradeGuide_Buyer.Trigger.make, {
                              onClick: (function (param) {
                                  setShowModal(function (param) {
                                        return /* Show */{
                                                _0: /* GradeGuide */0
