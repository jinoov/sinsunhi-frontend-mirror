module Fragment = %relay(`
  fragment PDPLikeButton_Fragment on Product {
    id
    viewerHasLiked
  }
`)
...
module Like_Mutation = %relay(`
  mutation PDPLikeButton_Like_Mutation($input: LikeProductInput!) {
...
module UnLike_Mutation = %relay(`
  mutation PDPLikeButton_Unlike_Mutation($input: UnlikeProductInput!) {
...
let make = (~query) => {
  ...
  let {id, viewerHasLiked} = query->Fragment.use
