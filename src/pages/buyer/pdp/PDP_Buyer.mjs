                                ...
                                className: "w-full flex justify-between"
                                        ...
                                        className: "mt-4 w-[496px] rounded-xl border border-gray-200 px-6 py-8"
                                            ...
                                            className: "mt-1 flex items-center justify-between"
                                                ...
                                                className: "w-[48px] h-[24px] rounded-md bg-gray-150 animate-pulse"
                                              })), React$1.createElement(ReactSeparator.Root, {
                        ...
                        className: "flex flex-col flex-1 w-[1280px] px-5 py-16 mx-auto"
                            ...
                            className: "mt-14"
                                ...
                                className: "w-full flex items-center justify-center"
                                  ...
                                  }, "상품이 존재하지 않습니다")), React$1.createElement("div", {
                                className: "mt-7 w-full flex flex-col items-center justify-center"
                              }, React$1.createElement("span", {
                                    className: "text-gray-800"
                                  }, "상품 URL이 정확한지 확인해주세요."), React$1.createElement("span", {
                                    className: "text-gray-800"
                                  }, "상품이 없을 경우 다른 카테고리의 상품을 선택해주세요.")))), React$1.createElement(Footer_Buyer.PC.make, {}));
    case /* Mobile */2 :
        return React$1.createElement("div", {
                    className: "w-full min-h-screen"
                  }, React$1.createElement("div", {
                            ...
                            className: "w-full max-w-3xl mx-auto bg-white min-h-screen"
                                ...
                                className: "w-full px-5 pt-[126px]"
                                    ...
                                    className: "flex flex-col items-center text-base text-text-L2"
                                      ...
                                      }, "상품이 존재하지 않습니다"), React$1.createElement("span", undefined, "상품 URL이 정확한지 확인해주세요."), React$1.createElement("span", undefined, "상품이 없을 경우 다른 카테고리의 상품을 선택해주세요."))), React$1.createElement(Footer_Buyer.MO.make, {}))));
                        ...
                        className: "w-[1280px] px-5 py-16 mx-auto"
                            ...
                            className: "mt-14"
                                ...
                                className: "w-full flex items-center justify-center"
                                    ...
                                    className: "text-3xl text-gray-800"
                                  }, "상품을 가져오는데 실패하였습니다")), React$1.createElement("div", {
                                className: "mt-7 w-full flex flex-col items-center justify-center"
                              }, React$1.createElement("span", {
                                    className: "text-gray-800"
                                  }, "상품 URL이 정확한지 확인해주세요."), React$1.createElement("span", {
                            ...
                            className: "w-full max-w-3xl mx-auto bg-white min-h-screen"
                                ...
                                className: "w-full px-5 pt-[126px]"
                                    ...
                                    className: "flex flex-col items-center text-base text-text-L2"
                                        ...
                                        className: "mb-2 text-xl text-text-L1"
                                      }, "상품을 가져오는데 실패하였습니다"), React$1.createElement("span", undefined, "상품 URL이 정확한지 확인해주세요."), React$1.createElement("span", undefined, "상품이 없을 경우 다른 카테고리의 상품을 선택해주세요."))), React$1.createElement(Footer_Buyer.MO.make, {}))));
...
function PDP_Buyer$Presenter(props) {
  ...
  if (match !== undefined) {
    if (match !== 2) {
      if (match >= 3) {
        return React$1.createElement(PDP_Matching_Buyer.make, {
                    deviceType: deviceType,
                    query: fragmentRefs
                  });
      } else {
        return React$1.createElement(PDP_Normal_Buyer.make, {
                    deviceType: deviceType,
                    query: fragmentRefs,
      ...
      return React$1.createElement(PDP_Quoted_Buyer.make, {
                  deviceType: deviceType,
                  query: fragmentRefs,
                  gnbBanners: gnbBanners,
                  displayCategories: displayCategories
...
function PDP_Buyer$Container(props) {
  ...
  if (product !== undefined) {
    return React$1.createElement(PDP_Buyer$Presenter, {
                deviceType: deviceType,
    ...
    return React$1.createElement(PDP_Buyer$NotFound, {
                deviceType: deviceType,
                gnbBanners: gnbBanners,
                displayCategories: displayCategories
              });
...
function PDP_Buyer$RedirectOldUrl$Redirector(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined);
}
...
function PDP_Buyer$RedirectOldUrl(props) {
  ...
  if (productId !== undefined) {
    return React$1.createElement(PDP_Buyer$Container, {
                deviceType: deviceType,
                productId: productId,
                gnbBanners: gnbBanners,
                displayCategories: displayCategories
    ...
    return React$1.createElement(PDP_Buyer$RedirectOldUrl$Redirector, {
                nodeId: pid,
                deviceType: deviceType,
                gnbBanners: gnbBanners,
                displayCategories: displayCategories
...
function $$default(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement(Head, {
                  ...
                  children: React$1.createElement(React$1.Suspense, {
                        children: Caml_option.some(match[0] && pid !== undefined ? React$1.createElement(PDP_Buyer$RedirectOldUrl, {
                                    pid: pid,
                                    deviceType: deviceType,
                                    gnbBanners: gnbBanners,
                                    displayCategories: displayCategories
                  ...
                  fallback: (function (param) {
                      return React$1.createElement(PDP_Buyer$Error, {
                                  deviceType: deviceType,
                                  gnbBanners: gnbBanners,
                                  displayCategories: displayCategories
                                });
