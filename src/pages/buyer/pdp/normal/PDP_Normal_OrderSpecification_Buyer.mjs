...
function PDP_Normal_OrderSpecification_Buyer$Tab(props) {
  var btnStyle = props.isSelected ? "bg-green-50 text-green-500 border-green-500" : "text-gray-800 border-gray-250";
  return React$1.createElement(ReactTabs.Trigger, {
              children: React$1.createElement("span", undefined, props.label),
              value: props.value,
...
function PDP_Normal_OrderSpecification_Buyer$CartBtn(props) {
  ...
  var selectedItems = make(product, props.selectedOptions);
  ...
  var showToast = function (message, toastType) {
    addToast(React$1.createElement("div", {
            ...
            }, toastType ? React$1.createElement(IconError.make, {
                    width: "24",
                    height: "24",
                    className: "mr-2"
...
function PDP_Normal_OrderSpecification_Buyer(props) {
  ...
  return React$1.createElement(ReactTabs.Root, {
              children: null,
              defaultValue: "excel",
              onValueChange: (function (selected) {
            ...
            }, React$1.createElement(ReactTabs.List, {
                  children: null,
                  className: "w-full h-12 flex px-4"
                }, React$1.createElement(PDP_Normal_OrderSpecification_Buyer$Tab, {
                      label: "2개 이상 배송지",
                      value: "excel",
                    ...
                    })), React$1.createElement(ReactTabs.Content, {
                  children: null,
                  value: "excel"
                }, React$1.createElement("div", {
                      className: "divide-y px-4 pt-1"
                    }, nonEmptyOptions.length !== 0 ? React$1.createElement(PDP_Normal_OrderSpecification_Buyer$Scroll, {
                    ...
                    }, React$1.createElement(PDP_Normal_OrderSpecification_Buyer$UploadBtn, {
                          selectedOptions: selectedOptions,
                          query: query
                        }))), React$1.createElement(ReactTabs.Content, {
                  children: null,
                  value: "wos"
                    ...
                    }, nonEmptyOptions$1.length !== 0 ? React$1.createElement(PDP_Normal_OrderSpecification_Buyer$Scroll, {
                            children: React$1.createElement("section", {
                                  className: "pt-1 pb-6"
                      ...
                      className: "w-full px-4 py-5 flex items-center"
                    }, React$1.createElement(PDP_Normal_OrderSpecification_Buyer$CartBtn, {
                          selectedOptions: selectedOptions,
                          ...
                          className: "w-2"
                        }), React$1.createElement(PDP_Normal_OrderSpecification_Buyer$WosBtn, {
                          selectedOptions: selectedOptions,
                          query: query
                        }))));
}
