  ...
  return React.createElement("div", {
              className: "relative container max-w-3xl mx-auto min-h-screen sm:shadow-gl pt-11"
                  ...
                  className: "px-5"
                      ...
                      className: "pt-7 text-[26px] font-bold leading-[38px]"
                    }, React.createElement(DS_Badge.Medium.make, {
                          text: "요청서를 보냈어요!",
                          colorType: "secondary"
                        }), React.createElement("h1", {
                          className: "mt-2"
                        }, "24시간 안으로 견적서를"), React.createElement("h1", undefined, "보내드립니다"), React.createElement("h3", {
                          className: "text-base text-text-L3 font-normal"
                        }, "카카오톡에서 확인하실 수 있어요"))), React.createElement(DS_ButtonContainer.Floating1.make, {
                  label: "카카오톡으로 확인하기",
                  onClick: (function (param) {
