...
function Profile_Buyer$Content$PC(props) {
  ...
  if (viewer !== undefined) {
    return React$1.createElement(MyInfo_Profile_Buyer.PC.make, {
...
function Profile_Buyer$Content$Mobile(props) {
  ...
  var viewer = queryData.viewer;
  if (viewer !== undefined) {
    return React$1.createElement(React$1.Fragment, undefined, React$1.createElement(MyInfo_Profile_Buyer.Mobile.make, {
                    query: viewer.fragmentRefs
                  }));
  } else {
    return React$1.createElement("div", undefined, "계정정보를 가져오는데 실패했습니다");
...
function $$default(param) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                  className: "w-full min-h-screen"
                }, param.deviceType !== 1 ? React$1.createElement(React$1.Fragment, undefined, React.createElementWithKey(Header_Buyer.Mobile.make, {}, router.asPath), React$1.createElement(RescriptReactErrorBoundary.make, {
                            children: React$1.createElement(React$1.Suspense, {
                                  children: Caml_option.some(React$1.createElement(Authorization.Buyer.make, {
                                            children: React$1.createElement(Profile_Buyer$Content$Mobile, {}),
                                            title: "신선하이"
                                          })),
                            ...
                            children: React$1.createElement(RescriptReactErrorBoundary.make, {
                                  children: React$1.createElement(React$1.Suspense, {
                                        children: Caml_option.some(React$1.createElement(Profile_Buyer$Content$PC, {})),
