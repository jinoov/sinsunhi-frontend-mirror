    ...
    <section className=%twc("flex-col bg-surface")>
      <div className=%twc("mx-auto py-20 max-w-7xl w-3/4")>
        ...
        <div className=%twc("mt-8 flex")>
          <div
            className=%twc(
              "py-10 flex flex-col bg-white min-w-[260px] w-[460px] min-h-[760px] shadow-pane rounded"
            )>
              ...
              <Next.Link href="/buyer/me/like">
                <a className=%twc("py-[18px] text-left px-7")>
                  <div className=%twc("w-fit")>
                    ...
                    | _ => <span> {`찜한 상품`->React.string} </span>
                    }}
                  </div>
                </a>
              </Next.Link>
              <Next.Link href="/buyer/me/recent-view">
                <a className=%twc("py-[18px] text-left px-7")>
                  <div className=%twc("w-fit")>
                    ...
                    | _ => <span> {`최근 본 상품`->React.string} </span>
                    }}
                  </div>
                </a>
              </Next.Link>
    ...
    <section className=%twc("flex-col bg-[#F0F2F5]")>
      <div className=%twc("w-full max-w-[1920px] mx-auto bg-[#FAFBFC]")>
        <div className=%twc("flex ")>
          <PC_MyInfo_Sidebar />
          <div className=%twc("flex flex-col flex-1 max-w-[1280px] mx-16 mt-10 mb-[60px]")>
            {children}
          </div>
        </div>
      </div>
