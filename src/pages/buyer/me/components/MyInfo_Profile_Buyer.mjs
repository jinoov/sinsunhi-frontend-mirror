  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement(MyInfo_Layout_Buyer.make, {
                  ...
                  children: React$1.createElement("div", {
                        className: "p-7 bg-white ml-4 w-full"
                          ...
                          }, "프로필정보"), React$1.createElement("div", {
                            className: "py-7 flex flex-col"
                                ...
                                className: "mb-2"
                                    ...
                                    className: "flex py-5"
                                      ...
                                      }, displayCategories, React$1.createElement("button", {
                                            className: "shrink-0",
                                    ...
                                    className: "flex py-5"
                                        ...
                                        className: "min-w-[168px] w-1/6 font-bold"
                                      }, "업종 정보"), React$1.createElement("div", {
                                        className: "flex items-center"
                                      }, displaySectors, React$1.createElement("button", {
                                            className: "shrink-0",
                                            onClick: (function (param) {
                                                setOpenModal(function (param) {
                                    ...
                                    className: "flex py-5"
                                        ...
                                        className: "min-w-[168px] w-1/6 font-bold"
                                      }, "연매출 정보"), React$1.createElement("div", {
                                        className: "flex items-center"
                ...
                }), React$1.createElement(Update_SectorAndSale_Buyer.make, {
                ...
                }), React$1.createElement(Update_InterestedCategories_Buyer.make, {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                  className: "block w-full bg-white absolute top-0 pt-14 min-h-screen"
                      ...
                      className: "w-full max-w-3xl mx-auto bg-white h-full"
                              ...
                              className: "py-10 flex flex-col items-center"
                            }, React$1.createElement(MyInfo_ProfilePicture_Buyer.make, {
                                  content: company,
                                  size: /* XLarge */2
                                }), React$1.createElement("button", {
                                  ...
                                  onClick: (function (param) {
                                    ...
                                    }, Belt_Option.getWithDefault(manager, "")), React$1.createElement("img", {
                                      className: "ml-1",
                                      height: "16px",
                                      src: "/assets/write.svg",
                                      width: "16px"
                                  ...
                                  onClick: (function (param) {
                                    ...
                                    }, company), React$1.createElement("img", {
                                      className: "ml-1",
                                      height: "16px",
                                      src: "/assets/write.svg",
                                      width: "16px"
                                  ...
                                  className: ""
                                    ...
                                    }, match$1.uid))), React$1.createElement("div", {
                              className: "h-3 bg-gray-100"
                            }), React$1.createElement("ul", undefined, React$1.createElement("li", undefined, React$1.createElement("button", {
                                      ...
                                      onClick: (function (param) {
                                          ...
                                          className: "flex items-center w-[calc(100%-16px)]"
                                            ...
                                            }, displayCategories)), React$1.createElement(IconArrow.make, {
                                          height: "16",
                                          width: "16",
                                          fill: "#B2B2B2"
                                        }))), React$1.createElement("li", undefined, React$1.createElement("button", {
                                      className: "w-full py-[18px] px-4 flex items-center justify-between",
                                      onClick: (function (param) {
                                          ...
                                          className: "flex items-center w-[calc(100%-16px)]"
                                            ...
                                            }, displaySectors)), React$1.createElement(IconArrow.make, {
                                          height: "16",
                                          width: "16",
                                          fill: "#B2B2B2"
                                        }))), React$1.createElement("li", undefined, React$1.createElement("button", {
                ...
                }, Belt_Option.getWithDefault(manager, "")));
}
