...
function MyInfo_Profile_Buyer$PC(Props) {
  ...
  var match = use(query);
  var displayCategories = Belt_Array.map(Belt_Option.getWithDefault(match.interestedItemCategories, []), (function (param) {
            return param.name;
          })).join(",");
  var displaySectors = Belt_Array.map(Belt_Option.getWithDefault(match.selfReportedBusinessSectors, []), (function (param) {
            return param.label;
          })).join(",");
  var match$1 = React.useState(function () {
        return false;
      });
  var setUpdateSectorAndSale = match$1[1];
  var match$2 = React.useState(function () {
        return false;
      });
  var setUpdateInterestedCategories = match$2[1];
                                ...
                                className: "mb-2"
                                    ...
                                    className: "flex py-5"
                                        ...
                                        className: "flex items-center"
                                            ...
                                            onClick: (function (param) {
                                                setUpdateInterestedCategories(function (param) {
                                                      return true;
                                                    });
                                              })
                                    ...
                                    className: "flex py-5"
                                        ...
                                        className: "flex items-center"
                                            ...
                                            className: "shrink-0",
                                            onClick: (function (param) {
                                                setUpdateSectorAndSale(function (param) {
                                                      return true;
                                                    });
                                              })
                                          }, React.createElement("img", {
                                    ...
                                    className: "flex py-5"
                                        ...
                                        className: "flex items-center"
                                      }, Belt_Option.mapWithDefault(match.selfReportedSalesBin, "", (function (param) {
                                              return param.label;
...
function MyInfo_Profile_Buyer$Mobile(Props) {
  ...
  var setUpdateComponentOpen = match$1[1];
  var match$2 = React.useState(function () {
        return false;
      });
  var setUpdateManagerOpen = match$2[1];
  var displayCategories = Belt_Array.map(Belt_Option.getWithDefault(match.interestedItemCategories, []), (function (param) {
            return param.name;
          })).join(", ");
  var displaySectors = Belt_Array.map(Belt_Option.getWithDefault(match.selfReportedBusinessSectors, []), (function (param) {
  ...
  var setUpdateSectorAndSale = match$3[1];
  var match$4 = React.useState(function () {
        return false;
      });
  var setUpdateInterestedCategories = match$4[1];
  var tmp = {
    isOpen: match$2[0],
    onClose: (function (param) {
                      ...
                      className: "w-full max-w-3xl mx-auto bg-white h-full"
                              ...
                              className: "py-10 flex flex-col items-center"
                                  ...
                                  className: ""
                                    ...
                                    }, match.uid))), React.createElement("div", {
