...
function MyInfo_Account_Buyer$PC(Props) {
  ...
  var match$4 = Belt_Option.map(verifications, (function (param) {
          return param.phoneVerificationStatus;
        }));
  var tmp$3;
  var exit$2 = 0;
  ...
  var match$5 = Belt_Option.map(verifications, (function (param) {
          return param.isValidBusinessRegistrationNumberByViewer;
        }));
  var tmp$4;
  var exit$3 = 0;
  ...
  var str$1 = Belt_Option.getWithDefault(address, "");
  var tmp$5 = {
    isOpen: Caml_obj.equal(openModal, /* Manager */2),
    onClose: (function (param) {
        setOpenModal(function (param) {
  ...
  if (manager !== undefined) {
    tmp$5.defaultValue = Caml_option.valFromOption(manager);
  }
  if (manager !== undefined) {
    tmp$5.key = manager;
  }
  return React.createElement(FeatureFlagWrapper.make, {
              children: React.createElement(React.Fragment, undefined, React.createElement(MyInfo_Layout_Buyer.make, {
                        query: query,
                        children: React.createElement("div", {
                              className: "pt-10 px-[50px] w-full rounded-sm bg-white shadow-[0px_10px_40px_10px_rgba(0,0,0,0.03)]"
                            }, React.createElement("div", {
                                  className: "font-bold text-2xl"
                                }, "계정정보"), React.createElement("div", {
                                  className: "py-7 flex flex-col"
                                          ...
                                          className: "flex pt-3 pb-5 border-b border-gray-100"
                                              ...
                                              className: "flex items-center"
                                                  ...
                                                  onClick: (function (param) {
                                                      ...
                                                      src: "/assets/write.svg",
                                                      width: "16px"
                                                    })), str$1 === "" ? React.createElement("span", {
                                                    className: "text-notice ml-2"
                                                  }, "입력 필요") : null))), React.createElement("div", {
                                      className: "mb-2"
                                    }, React.createElement("div", {
                        ...
                        defaultValue: company,
                        key: company
                      }), React.createElement(Update_Manager_Buyer.make, tmp$5), React.createElement(Update_PhoneNumber_Buyer.make, {
                        isOpen: Caml_obj.equal(openModal, /* Phone */3),
                        onClose: (function (param) {
                            setOpenModal(function (param) {
