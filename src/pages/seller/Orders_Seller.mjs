  ...
  return React$1.createElement("div", {
              className: "mt-5 bg-div-shape-L2 rounded-lg"
                  ...
                  className: "p-7"
                      ...
                      className: "relative"
                    }, "사전 품질관리를 통해 바이어와 소비자들의 신뢰도를 높이고 이를 통해 생산자분들께서 더 많은 매출을 올리실 수 있게끔", React$1.createElement("br", undefined), "온라인 QC - PASS 제도가 다음과 같이 시행될 예정임을 안내드립니다.", React$1.createElement("span", {
  ...
  if (orders$p$2.TAG === /* Ok */0) {
    ...
    tmp = React$1.createElement("ol", {
          className: "divide-y divide-gray-300 lg:divide-gray-100 lg:list-height-seller lg:overflow-y-scroll"
                  ...
                  return React.createElementWithKey(Order_Seller.make, {
                              order: order,
                              check: check,
                  ...
                  className: "w-full overflow-x-scroll"
                      ...
                      className: "text-sm lg:min-w-max"
                          ...
                          className: "hidden lg:grid lg:grid-cols-11-gl-seller bg-gray-100 text-gray-500 h-12"
                              ...
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "상품번호·옵션번호"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
...
function Orders_Seller$Orders(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                ...
                }, React$1.createElement(Orders_Seller$Notice, {}), React$1.createElement(Summary_Order_Seller.make, {}), React$1.createElement("div", {
                              ...
                              className: "pt-10 px-5 lg:px-0 flex flex-col lg:flex-row sm:flex-auto sm:justify-between"
                                  ...
                                  className: "flex flex-col lg:flex-row mt-4 lg:mt-0"
                                      ...
                                      className: "flex mt-2 lg:mt-0"
                                          ...
                                          }, "상품준비중으로 변경") : null, React$1.createElement(Excel_Download_Request_Button.make, {
                                          userType: /* Seller */0,
                                          requestUrl: "/order/request-excel/farmer"
                                        }))))), React$1.createElement(Orders_Seller$List, {
                          status: status,
                          check: check,
                  ...
                  textOnCancel: "확인"
                      ...
                      className: "text-black-gl text-center whitespace-pre-wrap"
                    }, "상품준비중으로 변경할 주문을 선택해주세요.")), React$1.createElement(Dialog.make, {
                  isShow: match$5[0],
                  children: React$1.createElement("p", {
...
function Orders_Seller(props) {
  return React$1.createElement(Authorization.Seller.make, {
              children: React$1.createElement(Orders_Seller$Orders, {}),
              title: "주문내역 조회"
            });
}
