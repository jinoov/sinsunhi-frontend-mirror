...
function Guide_Upload_Buyer$NewUI(Props) {
  return React.createElement("div", {
              className: "container lg:max-w-[1280px] lg:min-w-[872px] flex flex-col rounded-sm bg-white shadow-[0px_10px_40px_10px_rgba(0,0,0,0.03)]  w-full mt-4 "
            }, React.createElement(ReactAccordion.Root, {
                  children: null,
                  type: "multiple"
                }, React.createElement(ReactAccordion.Item, {
