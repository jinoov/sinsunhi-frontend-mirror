  ...
  return React.createElement("div", {
              className: "w-full flex gap-3 pt-7"
                  ...
                  className: Cx.cx([
                        ...
                        isLast ? "" : "border border-x-0 border-t-0"
                      ])
                }, React.createElement("div", {
                      className: "flex flex-row w-full justify-between items-center"
                        ...
                        }, "" + Locale.Int.show(undefined, data.totalPrice) + "원")), React.createElement(Web_Order_Complete_Product_Info_Buyer$List, {
...
function Web_Order_Complete_Product_Info_Buyer$ProductCard$MO(Props) {
  ...
  var isLast = Props.isLast;
  return React.createElement("div", {
              className: isLast ? "" : "border border-x-0 border-t-0 pb-5"
            }, React.createElement("div", {
...
function Web_Order_Complete_Product_Info_Buyer$ProductCard(Props) {
  ...
  switch (deviceType) {
    case /* Unknown */0 :
        return null;
    case /* PC */1 :
        return React.createElement(Web_Order_Complete_Product_Info_Buyer$ProductCard$PC, {
                    data: data,
                    isLast: isLast
                  });
    case /* Mobile */2 :
        return React.createElement(Web_Order_Complete_Product_Info_Buyer$ProductCard$MO, {
                    data: data,
                    isLast: isLast
                  });
    ...
    return React.createElement("section", {
                className: "flex flex-col bg-white rounded-sm"
                    ...
                    className: "text-lg xl:text-xl text-enabled-L1 font-bold"
                      ...
                      return React.createElement(Web_Order_Complete_Product_Info_Buyer$ProductCard, {
                                  data: data,
