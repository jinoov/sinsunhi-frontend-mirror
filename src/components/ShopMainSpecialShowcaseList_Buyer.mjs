...
function ShopMainSpecialShowcaseList_Buyer$PC$Placeholder(props) {
  return React$1.createElement("div", undefined, Belt_Array.map(Belt_Array.range(1, 10), (function (categoryIdx) {
                                ...
                                className: containerStyle
                                    ...
                                    className: "w-[1280px] mx-auto px-5"
                                        ...
                                        className: "mt-12 grid grid-cols-4 gap-x-10 gap-y-16"
                                              ...
                                              return React.createElementWithKey(ShopProductListItem_Buyer.PC.Placeholder.make, {}, "category-" + String(categoryIdx) + "-product-skeleton-" + String(idx) + "");
                                            })))));
                  })));
}
                  ...
                  return React$1.createElement("section", {
                              ...
                              className: containerStyle
                                  ...
                                  className: "w-[1280px] mx-auto px-5"
                                    ...
                                    }, param.name), React$1.createElement("ol", {
                                      className: "mt-12 grid grid-cols-4 gap-x-10 gap-y-16"
                                    }, Belt_Array.map(edges, (function (param) {
                                            return React.createElementWithKey(React$1.Suspense, {
                                                        children: Caml_option.some(React$1.createElement(ShopProductListItem_Buyer.PC.make, {
                                                                  query: param.node.fragmentRefs
                                                                })),
                                                        fallback: Caml_option.some(React$1.createElement(ShopProductListItem_Buyer.PC.Placeholder.make, {}))
                                                      }, "main-special-category-" + id + "-list-item-" + param.cursor + "-pc");
                                          }))), match.pageInfo.hasNextPage ? React$1.createElement("div", {
                                ...
                                className: "w-full px-5 mt-12"
                                    ...
                                    className: "w-full"
                                        ...
                                        className: "mt-4 grid grid-cols-2 gap-x-4 gap-y-8"
                                              ...
                                              return React.createElementWithKey(ShopProductListItem_Buyer.MO.Placeholder.make, {}, "category-" + String(categoryIdx) + "-product-skeleton-" + String(idx) + "");
                                            })))));
                  })));
}
                              ...
                              className: "w-full px-5 mt-12"
                                  ...
                                  className: "w-full"
                                      ...
                                      className: "mt-4 grid grid-cols-2 gap-x-4 gap-y-8"
                                            ...
                                            return React.createElementWithKey(React$1.Suspense, {
                                                        children: Caml_option.some(React$1.createElement(ShopProductListItem_Buyer.MO.make, {
                                                                  query: param.node.fragmentRefs
                                                                })),
                                                        fallback: Caml_option.some(React$1.createElement(ShopProductListItem_Buyer.MO.Placeholder.make, {}))
                                                      }, "main-special-category-" + id + "-list-item-" + param.cursor + "-mobile");
                                          }))), match.pageInfo.hasNextPage ? React$1.createElement("div", {
