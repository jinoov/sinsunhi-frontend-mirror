...
function use(variables, fetchPolicy, fetchKey, networkCacheConfig, param) {
  var data = ReactRelay.useLazyLoadQuery(SelectBulkSaleCropQuery_graphql.node, RescriptRelay_Internal.internal_cleanObjectFromUndefinedRaw(SelectBulkSaleCropQuery_graphql.Internal.convertVariables(variables)), {
        fetchKey: fetchKey,
...
function useLoader(param) {
  var match = ReactRelay.useQueryLoader(SelectBulkSaleCropQuery_graphql.node);
...
function $$fetch(environment, variables, onResult, networkCacheConfig, fetchPolicy, param) {
  ReactRelay.fetchQuery(environment, SelectBulkSaleCropQuery_graphql.node, SelectBulkSaleCropQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
...
function fetchPromised(environment, variables, networkCacheConfig, fetchPolicy, param) {
  var __x = ReactRelay.fetchQuery(environment, SelectBulkSaleCropQuery_graphql.node, SelectBulkSaleCropQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
          fetchPolicy: RescriptRelay.mapFetchQueryFetchPolicy(fetchPolicy)
        }).toPromise();
...
function usePreloaded(queryRef, param) {
  var data = ReactRelay.usePreloadedQuery(SelectBulkSaleCropQuery_graphql.node, queryRef);
  return RescriptRelay_Internal.internal_useConvertedValue(SelectBulkSaleCropQuery_graphql.Internal.convertResponse, data);
}
