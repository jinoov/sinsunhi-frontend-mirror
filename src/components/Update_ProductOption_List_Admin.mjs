...
function Update_ProductOption_List_Admin(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                  className: "flex justify-between items-center"
                    ...
                    }, "단품 정보", React$1.createElement("span", {
                          className: "text-sm text-green-gl ml-2 font-normal"
                        }, "단품 " + String(fields.length + edges.length | 0) + "개")), React$1.createElement("input", {
                      ref: listId.ref,
                    ...
                    }, "단품 추가하기")), React$1.createElement("div", {
                  className: "flex flex-col mt-7 mb-3 gap-6"
                }, Belt_Array.mapWithIndex(fields, (function (index, field) {
                        return React.createElementWithKey(Add_ProductOption_Admin.make, {
                        ...
                        return React.createElementWithKey(Update_ProductOption_Admin.make, {
