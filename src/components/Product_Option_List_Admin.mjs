                  ...
                  className: "w-full overflow-x-scroll"
                      ...
                      className: "min-w-max text-sm divide-y divide-gray-100"
                          ...
                          className: "grid grid-cols-15-admin-product bg-gray-100 text-gray-500 h-12"
                            ...
                            }, "상품상태·단품상태"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                              ...
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "현재 판매가"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "작물명·품종명"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "중량·입수(박스당)"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "개당 무게·크기"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "등급·포장규격"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "담당소싱MD"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "출고기준시간"), React$1.createElement("div", {
                              className: "h-full px-4 flex items-center whitespace-nowrap"
                            }, "메모")), React$1.createElement("ol", {
                          className: "divide-y divide-gray-100 lg:list-height-admin-buyer lg:overflow-y-scroll"
                        }, Garter_Array.isEmpty(productOptions.edges) ? React$1.createElement(EmptyProducts.make, {}) : Garter_Array.map(productOptions.edges, (function (edge) {
                                  return React.createElementWithKey(Product_Option_Admin.make, {
