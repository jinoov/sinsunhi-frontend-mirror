...
function Download_Center_Table$DownloadTableHead(props) {
  return React$1.createElement("header", undefined, React$1.createElement("ul", {
                  className: "sm:flex hidden flex-row items-center w-full py-3 px-4 bg-gray-50 rounded mt-4 text-sm text-text-L2"
                    ...
                    }, "요청일시"), React$1.createElement("li", {
                      className: "w-2/5"
                    }, "파일명"), React$1.createElement("li", {
                      className: "w-2/5"
                    }, "다운로드")));
}
...
function Download_Center_Table$DownloadTableRow(props) {
  ...
  var statusSplit = function (param) {
    ...
    if (status !== 2) {
      ...
      return React$1.createElement("p", {
                ...
                }, React$1.createElement("span", undefined, "생성완료"), React$1.createElement("img", {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("ul", {
                  className: "flex flex-row items-center w-full py-4 border-b border-div-border-L2 flex-wrap sm:py-3 sm:px-4 sm:flex-nowrap"
                    ...
                    }, React$1.createElement("span", undefined, match$2[0]), React$1.createElement("span", {
                          className: "text-text-L2 ml-1"
                        }, match$2[1])), React$1.createElement("li", {
  ...
  return React$1.createElement("div", {
              className: "mt-5 p-5 bg-white rounded w-full min-h-[50vh] sm:min-h-[75vh] sm:p-7 sm:shadow-gl"
                  ...
                  className: "flex items-center mb-3"
                      ...
                      className: "font-bold"
                    }, "다운로드 요청내역"), React$1.createElement("span", {
                      className: "ml-2 text-primary"
                    }, "" + String(count) + "건")), React$1.createElement("div", {
                  className: "flex flex-col sm:flex-row sm:justify-between sm:items-center"
                }, React$1.createElement("span", {
                      className: "sm:text-sm"
                    }, "생성완료 후 7일간 다운로드 가능합니다."), count !== 0 ? React$1.createElement(Select_CountPerPage.make, {
                        className: "my-5 sm:my-0 w-fit"
                      }) : null), count !== 0 ? React$1.createElement(React$1.Fragment, undefined, React$1.createElement(Download_Center_Table$DownloadTableHead, {}), React$1.createElement("main", undefined, Belt_Array.map(downloads$p.data, (function (data) {
                              return React.createElementWithKey(Download_Center_Table$DownloadTableRow, {
                                          data: data
                                        }, data.filename + data.requestAt);
