...
function BulkSale_Producer_Admin$Gallery(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("span", {
                ...
                }, "사진 보기"), React$1.createElement(ReactImagesViewer, {
...
function BulkSale_Producer_Admin$Item$Table(props) {
  var application = use(props.node.fragmentRefs);
  ...
  return React$1.createElement("li", {
              className: "grid grid-cols-11-admin-bulk-sale-producers"
                ...
                }, Format(new Date(application.appliedAt), "yyyy/MM/dd HH:mm")), React$1.createElement("div", {
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement(Select_BulkSale_Application_Status.make, {
                  ...
                  className: "h-full flex flex-col justify-center px-4 py-2 relative"
                    ...
                    }, React.createElementWithKey(Select_BulkSale_Search.Staff.make, {
                          applicationId: application.id,
                          staffInfo: staff$p !== undefined ? /* Selected */({
                                value: staff$p.id,
                                label: staff$p.name + "( " + Garter_Array.firstExn(staff$p.emailAddress.split("@")) + " )"
                              }) : /* NotSelected */0
                        }, application.id))), React$1.createElement("div", {
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement("p", {
                      className: "mb-2"
                    }, campaign !== undefined ? "" + campaign.productCategory.crop.name + " > " + campaign.productCategory.name + "" : "" + application.productCategory.crop.name + " > " + application.productCategory.name + ""), React$1.createElement(BulkSale_Producer_Sample_Review_Button_Admin.make, {
                      applicationId: application.id,
                      sampleReview: application.fragmentRefs
                    })), React$1.createElement("div", {
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement("p", undefined, campaign$1 !== undefined ? "" + Locale.Float.show(undefined, campaign$1.estimatedPurchasePriceMin, 0) + "원~" + Locale.Float.show(undefined, campaign$1.estimatedPurchasePriceMax, 0) + "원" : null, React$1.createElement("span", {
                          className: "text-text-L2"
                              ...
                              })))), React$1.createElement("p", undefined, Belt_Option.mapWithDefault(application.bulkSaleCampaign, null, (function (campaign) {
                  ...
                  className: "h-full flex flex-row justify-between px-4 py-3"
                          ...
                          })), "", displayAnnualProductSalesInfo)), React$1.createElement("div", {
                  className: "h-full flex flex-row justify-between px-4 py-3"
                  ...
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement(BulkSale_Producer_MarketSales_Admin.make, {
                  ...
                  className: "h-full flex flex-col justify-center px-4 py-2"
                          ...
                          })), false) ? "예" : "아니오"), React$1.createElement("div", {
                  className: "h-full flex flex-row justify-between px-4 py-3"
                }, Garter_Array.isEmpty(imageUrls) ? React$1.createElement("span", undefined, "사진 없음") : React$1.createElement(BulkSale_Producer_Admin$Gallery, {
                        imageUrls: imageUrls
                      })), React$1.createElement("div", {
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement("div", {
                      className: "flex"
                    }, React$1.createElement("p", undefined, application.applicantName === "" ? "사용자: " + application.farmmorningUser.name + "" : "사용자: " + application.applicantName + ""), application.farmmorningUser.isDeleted ? React$1.createElement("span", {
                            className: "ml-2 py-0.5 px-1.5 text-xs bg-red-100 text-notice rounded"
                          }, "탈퇴") : null), React$1.createElement("p", undefined, name === "" ? null : "사업자: " + name + ""), React$1.createElement("p", undefined, "(" + Belt_Option.getWithDefault(parsedPhoneNumber, Belt_Option.getWithDefault(phoneNumber, application.farmmorningUser.phoneNumber)) + ")"), React$1.createElement("p", {
                      className: "text-text-L3"
                              ...
                              })), "주소 없음")), React$1.createElement("p", {
                      className: "text-text-L3"
                    }, zipCode !== undefined ? "우)" + zipCode + "" : "(우편번호 없음)")), React$1.createElement("div", {
                  className: "h-full flex flex-row justify-between px-4 py-3"
                  ...
                  className: "h-full flex flex-col justify-center px-4 py-2"
                }, React$1.createElement("p", undefined, Belt_Option.mapWithDefault(Belt_Option.flatMap(application.bulkSaleProducerDetail, (function (d) {
                                return d.experienceYearType;
                              })), "", displayExperiencedYearRange))), React$1.createElement("div", {
                  className: "h-full flex flex-row justify-between px-4 py-3"
                }, Belt_Option.getWithDefault(Belt_Option.flatMap(application.bulkSaleProducerDetail, (function (d) {
                  ...
                  className: "h-full flex flex-row justify-between px-4 py-3"
                    ...
                    }, application.memo), React$1.createElement(BulkSale_Producer_Memo_Update_Button.make, {
                      applicationId: application.id,
...
function BulkSale_Producer_Admin$Item$Table$Loading(props) {
  return React$1.createElement("li", {
              className: "grid grid-cols-7-admin-bulk-sale-product"
                ...
                }, React$1.createElement(Checkbox.make, {})), React$1.createElement("div", {
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {
                      className: "w-20"
                    }), React$1.createElement(Skeleton.Box.make, {}), React$1.createElement(Skeleton.Box.make, {
                      className: "w-12"
                    })), React$1.createElement("div", {
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {}), React$1.createElement(Skeleton.Box.make, {})), React$1.createElement("div", {
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {}), React$1.createElement(Skeleton.Box.make, {
                      className: "w-2/3"
                    }), React$1.createElement(Skeleton.Box.make, {
                  ...
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {})), React$1.createElement("div", {
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {})), React$1.createElement("div", {
                  className: "h-full flex flex-col px-4 py-2"
                }, React$1.createElement(Skeleton.Box.make, {}), React$1.createElement(Skeleton.Box.make, {})));
...
function BulkSale_Producer_Admin(props) {
  return React$1.createElement(BulkSale_Producer_Admin$Item$Table, {
              node: props.node,
              refetchSummary: props.refetchSummary
            });
}
