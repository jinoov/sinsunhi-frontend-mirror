...
function Add_ProductOption_Admin$AmountInput(props) {
  ...
  var control = match.control;
  var match$1 = match.register(props.amountInputName, {
        required: true,
        min: 0,
        valueAsNumber: true
      });
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("div", {
                  className: "py-6 flex flex-col gap-2"
                      ...
                      className: "flex items-center gap-2"
                          ...
                          defaultValue: Caml_option.some(Select_Product_Option_Unit.Amount.status_encode(/* KG */1))
                        }), React.createElement("div", {
                          className: "flex gap-2 items-center grow"
                        }, React.createElement(ReactHookForm$1.Controller, {
                              name: props.showEachInputName,
                              control: Caml_option.some(control),
                              render: (function (param) {
                                  var match = param.field;
                                  var onChange = match.onChange;
                              ...
                              defaultValue: Caml_option.some(false)
                          ...
                          className: "flex flex-col gap-2"
                              ...
                              className: "flex justify-between"
                                  ...
                                  className: "flex items-center justify-start"
                                      ...
                                      disabled: props.isOnlyOneRemained,
                            ...
                            className: "divide-y"
                                ...
                                className: "flex flex-col gap-6 py-6 w-full"
                                    ...
                                    className: "flex gap-4 items-center justify-start"
                                      ...
                                      }), props.isCourierAvailable ? React.createElement(Add_ProductOption_Admin$DeliveryCostInput, {
                                    ...
                                    inputName: inputNames.memo
                                      ...
                                      className: "flex gap-2 items-center"
                                          ...
                                          onClick: onClickApplyAll
                                            ...
                                            })), React.createElement("span", undefined, "[" + props.productDisplayName + "] 전체 단품에 출고기준시간과 메모 동일하게 적용하기")))),
