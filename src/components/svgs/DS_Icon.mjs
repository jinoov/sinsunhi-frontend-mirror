...
function DS_Icon$Common$SelectLarge1(props) {
  ...
  return React.createElement("svg", {
              ...
              xmlns: "http://www.w3.org/2000/svg"
                  ...
                  fill: Belt_Option.getWithDefault(fill, "black"),
                  stroke: Belt_Option.getWithDefault(stroke, "black"),
                  strokeLinecap: "round",
...
function DS_Icon$Common$PeriodSmall1(props) {
  ...
  return React.createElement("svg", {
              ...
              xmlns: "http://www.w3.org/2000/svg"
                  ...
                  cy: "7",
                  r: "6.4",
                  stroke: Belt_Option.getWithDefault(fill, "#FF2B35"),
                  strokeWidth: "1.2"
                }), React.createElement("path", {
                  ...
                  fill: Belt_Option.getWithDefault(fill, "#FF2B35")
                }), React.createElement("path", {
...
var PeriodSmall1 = {
  make: DS_Icon$Common$PeriodSmall1
};

var Common = {
  LineCheckedMedium1: LineCheckedMedium1,
  LineCheckedLarge1: LineCheckedLarge1,
  CheckedLarge1: CheckedLarge1,
  UncheckedLarge1: UncheckedLarge1,
  DeleteMedium1: DeleteMedium1,
  ArrowLeftXLarge1: ArrowLeftXLarge1,
  ArrowRightLarge1: ArrowRightLarge1,
  RadioOnLarge1: RadioOnLarge1,
  RadioOffLarge1: RadioOffLarge1,
  SelectLarge1: SelectLarge1,
  CheckedLarge2: CheckedLarge2,
  ArrowDownLarge1: ArrowDownLarge1,
  RefreshMedium1: RefreshMedium1,
  ClearMedium1: ClearMedium1,
  PlusSmall1: PlusSmall1,
  EditSmall1: EditSmall1,
  CloseLarge2: CloseLarge2,
  PeriodSmall1: PeriodSmall1
};
