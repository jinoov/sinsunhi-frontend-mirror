...
function toString(status) {
  return Js_json.decodeString(status ? "불가능" : "가능");
}
  ...
  return React.createElement("span", undefined, React.createElement("label", {
                  className: "block relative"
                      ...
                      className: "absolute top-1.5 right-2"
                          ...
                          disabled: true,
                          value: ""
                        }, "택배가능여부 선택"), Belt_Array.map([
                          /* AVAILABLE */0,
                          /* UNAVAILABLE */1
                        ], (function (s) {
                            var value = Belt_Option.getWithDefault(Js_json.decodeString(s ? "불가능" : "가능"), "");
