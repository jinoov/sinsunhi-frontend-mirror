...
import * as Query_Delivery_Form_Admin from "./Query_Delivery_Form_Admin.mjs";

function Summary_Delivery_Admin$StatusFilter(Props) {
...
var StatusFilter = {
  make: Summary_Delivery_Admin$StatusFilter
};

function Summary_Delivery_Admin(Props) {
  ...
  var onSubmit = function (param) {
    ...
    var farmerName = Query_Delivery_Form_Admin.FormFields.get(state.values, /* FarmerName */0);
    var orderProductNo = Query_Delivery_Form_Admin.FormFields.get(state.values, /* OrderProductNo */1);
    var productId = Query_Delivery_Form_Admin.FormFields.get(state.values, /* ProductId */2);
    var sku = Query_Delivery_Form_Admin.FormFields.get(state.values, /* Sku */5);
    var ordererName = Query_Delivery_Form_Admin.FormFields.get(state.values, /* OrdererName */3);
    var receiverName = Query_Delivery_Form_Admin.FormFields.get(state.values, /* ReceiverName */4);
    router.query["farmer-name"] = farmerName;
  ...
  var form = Curry._7(Query_Delivery_Form_Admin.Form.use, Query_Delivery_Form_Admin.initialState, /* Schema */{
        _0: Belt_Array.concatMany([
              Curry._4(Query_Delivery_Form_Admin.Form.ReSchema.Validation.regExp, "최소 2글자를 입력해주세요.", "^(?:.{2,}|)$", undefined, /* OrdererName */3),
              Curry._4(Query_Delivery_Form_Admin.Form.ReSchema.Validation.regExp, "최소 2글자를 입력해주세요.", "^(?:.{2,}|)$", undefined, /* ReceiverName */4)
            ])
  ...
  React.useEffect((function () {
          ...
          Garter_Array.forEach(Js_dict.entries(router.query), (function (entry) {
                  ...
                  var k = entry[0];
                  if (k === "farmer-name") {
                    return Curry._4(form.setFieldValue, /* FarmerName */0, v, true, undefined);
  ...
  var handleOnReset = function (param) {
    return ReactEvents.interceptingHandler((function (param) {
                  Curry._4(form.setFieldValue, /* FarmerName */0, "", true, undefined);
  ...
  var partial_arg = Curry._1(form.handleChange, /* FarmerName */0);
  ...
  return React.createElement("div", {
            ...
            }, React.createElement(Summary_Delivery_Admin$StatusFilter, {}), React.createElement("form", {
                  onSubmit: handleOnSubmit
                      ...
                      className: "py-6 flex flex-col text-sm bg-gray-gl rounded-xl"
                          ...
                          className: "flex"
                              ...
                              className: "w-32 font-bold mt-2 pl-7"
                              ...
                              className: "flex-1"
                                  ...
                                  className: "flex"
                                      ...
                                      className: "w-64 flex items-center mr-16"
                                          ...
                                          name: "farmer-name",
                                          placeholder: "생산자명 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* FarmerName */0),
                                      ...
                                      className: "w-64 flex items-center mr-16"
                                          ...
                                          name: "orderer-name",
                                          placeholder: "주문자명 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* OrdererName */3),
                                          onChange: (function (param) {
                                      ...
                                      className: "w-64 flex items-center mr-16"
                                          ...
                                          name: "receiver-name",
                                          placeholder: "수취인명 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* ReceiverName */4),
                                          onChange: (function (param) {
                                  ...
                                  className: "flex mt-3"
                                      ...
                                      className: "w-64 flex items-center mr-16"
                                          ...
                                          placeholder: "주문번호 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* OrderProductNo */1),
                                          onChange: (function (param) {
                                      ...
                                      className: "w-64 flex items-center mr-16"
                                          ...
                                          name: "product-id",
                                          placeholder: "상품번호 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* ProductId */2),
                                          onChange: (function (param) {
                                      ...
                                      className: "w-64 flex items-center"
                                          ...
                                          name: "sku",
                                          placeholder: "단품번호 입력",
                                          value: Query_Delivery_Form_Admin.FormFields.get(form.values, /* Sku */5),
                                          onChange: (function (param) {
...
var make = Summary_Delivery_Admin;
