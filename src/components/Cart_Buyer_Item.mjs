...
import * as CartBuyerItemQuery_graphql from "../__generated__/CartBuyerItemQuery_graphql.mjs";
import * as CartBuyerItemFragment_graphql from "../__generated__/CartBuyerItemFragment_graphql.mjs";
import * as CartItemBuyerRefetchQuery_graphql from "../__generated__/CartItemBuyerRefetchQuery_graphql.mjs";
import * as CartBuyerItemQuery_Temp_Query_graphql from "../__generated__/CartBuyerItemQuery_Temp_Query_graphql.mjs";
...
function useRefetchable(fRef) {
  var match = ReactRelay.useRefetchableFragment(CartBuyerItemFragment_graphql.node, fRef);
...
var makeRefetchVariables = CartItemBuyerRefetchQuery_graphql.Types.makeRefetchVariables;
...
function use$1(variables, fetchPolicy, fetchKey, networkCacheConfig, param) {
  var data = ReactRelay.useLazyLoadQuery(CartBuyerItemQuery_graphql.node, RescriptRelay_Internal.internal_cleanObjectFromUndefinedRaw(CartBuyerItemQuery_graphql.Internal.convertVariables(variables)), {
        fetchKey: fetchKey,
        fetchPolicy: RescriptRelay.mapFetchPolicy(fetchPolicy),
        networkCacheConfig: networkCacheConfig
      });
  return RescriptRelay_Internal.internal_useConvertedValue(CartBuyerItemQuery_graphql.Internal.convertResponse, data);
}
...
function $$fetch(environment, variables, onResult, networkCacheConfig, fetchPolicy, param) {
  ReactRelay.fetchQuery(environment, CartBuyerItemQuery_graphql.node, CartBuyerItemQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
        ...
        next: (function (res) {
            Curry._1(onResult, {
                  TAG: /* Ok */0,
                  _0: CartBuyerItemQuery_graphql.Internal.convertResponse(res)
                });
          }),
        error: (function (err) {
            Curry._1(onResult, {
...
function fetchPromised(environment, variables, networkCacheConfig, fetchPolicy, param) {
  var __x = ReactRelay.fetchQuery(environment, CartBuyerItemQuery_graphql.node, CartBuyerItemQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
          fetchPolicy: RescriptRelay.mapFetchQueryFetchPolicy(fetchPolicy)
        }).toPromise();
  return Js_promise.then_((function (res) {
                return Promise.resolve(CartBuyerItemQuery_graphql.Internal.convertResponse(res));
              }), __x);
}

function usePreloaded(queryRef, param) {
  var data = ReactRelay.usePreloadedQuery(CartBuyerItemQuery_graphql.node, queryRef);
  return RescriptRelay_Internal.internal_useConvertedValue(CartBuyerItemQuery_graphql.Internal.convertResponse, data);
}

function retain(environment, variables) {
  var operationDescriptor = RelayRuntime.createOperationDescriptor(CartBuyerItemQuery_graphql.node, CartBuyerItemQuery_graphql.Internal.convertVariables(variables));
...
function use$2(variables, fetchPolicy, fetchKey, networkCacheConfig, param) {
  var data = ReactRelay.useLazyLoadQuery(CartBuyerItemQuery_Temp_Query_graphql.node, RescriptRelay_Internal.internal_cleanObjectFromUndefinedRaw(CartBuyerItemQuery_Temp_Query_graphql.Internal.convertVariables(variables)), {
        fetchKey: fetchKey,
        fetchPolicy: RescriptRelay.mapFetchPolicy(fetchPolicy),
        networkCacheConfig: networkCacheConfig
      });
  return RescriptRelay_Internal.internal_useConvertedValue(CartBuyerItemQuery_Temp_Query_graphql.Internal.convertResponse, data);
}
...
function $$fetch$1(environment, variables, onResult, networkCacheConfig, fetchPolicy, param) {
  ReactRelay.fetchQuery(environment, CartBuyerItemQuery_Temp_Query_graphql.node, CartBuyerItemQuery_Temp_Query_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
          fetchPolicy: RescriptRelay.mapFetchQueryFetchPolicy(fetchPolicy)
        }).subscribe({
        next: (function (res) {
            Curry._1(onResult, {
                  TAG: /* Ok */0,
                  _0: CartBuyerItemQuery_Temp_Query_graphql.Internal.convertResponse(res)
                });
          }),
        error: (function (err) {
            Curry._1(onResult, {
...
function fetchPromised$1(environment, variables, networkCacheConfig, fetchPolicy, param) {
  var __x = ReactRelay.fetchQuery(environment, CartBuyerItemQuery_Temp_Query_graphql.node, CartBuyerItemQuery_Temp_Query_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
          fetchPolicy: RescriptRelay.mapFetchQueryFetchPolicy(fetchPolicy)
        }).toPromise();
  return Js_promise.then_((function (res) {
                return Promise.resolve(CartBuyerItemQuery_Temp_Query_graphql.Internal.convertResponse(res));
              }), __x);
}

function usePreloaded$1(queryRef, param) {
  var data = ReactRelay.usePreloadedQuery(CartBuyerItemQuery_Temp_Query_graphql.node, queryRef);
  return RescriptRelay_Internal.internal_useConvertedValue(CartBuyerItemQuery_Temp_Query_graphql.Internal.convertResponse, data);
}

function retain$1(environment, variables) {
  var operationDescriptor = RelayRuntime.createOperationDescriptor(CartBuyerItemQuery_Temp_Query_graphql.node, CartBuyerItemQuery_Temp_Query_graphql.Internal.convertVariables(variables));
  return environment.retain(operationDescriptor);
}
...
function Cart_Buyer_Item(props) {
  ...
  var productNos = Belt_Array.map(queryData.cartItems, (function (cartItem) {
          return cartItem.productId;
        }));
  var tempQuery = Belt_Array.map(productNos, (function (productNo) {
          return use$2({
                      number: productNo
                    }, undefined, undefined, undefined, undefined);
        }));
  var toTupleTemp = function (product) {
    if (product.NAME === "UnselectedUnionMember") {
      return ;
    }
    var product$1 = product.VAL;
    return [
            product$1.number,
            product$1.isCourierAvailable
          ];
  };
  var productIdMapTemp = Belt_MapInt.fromArray(Belt_Array.keepMap(tempQuery, (function (a) {
              return Belt_Option.flatMap(a.product, toTupleTemp);
            })));
  var data = Belt_Array.keepMap(Cart_Buyer_Form.groupBy(queryData.cartItems), Cart_Buyer_Form.map);
  var match$2 = Belt_Array.partition(data, (function (cartItem) {
          return Belt_Option.getWithDefault(Belt_MapInt.get(productIdMapTemp, cartItem.productId), false);
        }));
  var unCourierAvailableData = match$2[1];
  var courierAvailableData = match$2[0];
  ...
  var match$3 = courierAvailableData.length;
  var defaultOrderType = match$3 !== 0 ? "CourierAvailable" : "UnCourierAvailable";
