...
import * as SearchProductCategoryQuery_graphql from "../__generated__/SearchProductCategoryQuery_graphql.mjs";

function use(variables, fetchPolicy, fetchKey, networkCacheConfig, param) {
  var data = Hooks.useLazyLoadQuery(SearchProductCategoryQuery_graphql.node, RescriptRelay_Internal.internal_cleanObjectFromUndefinedRaw(SearchProductCategoryQuery_graphql.Internal.convertVariables(variables)), {
        fetchKey: fetchKey,
        fetchPolicy: RescriptRelay.mapFetchPolicy(fetchPolicy),
        networkCacheConfig: networkCacheConfig
      });
  return RescriptRelay_Internal.internal_useConvertedValue(SearchProductCategoryQuery_graphql.Internal.convertResponse, data);
}

function useLoader(param) {
  var match = Hooks.useQueryLoader(SearchProductCategoryQuery_graphql.node);
  var loadQueryFn = match[1];
  var loadQuery = React.useMemo((function () {
          return function (param, param$1, param$2, param$3) {
            return Curry._2(loadQueryFn, SearchProductCategoryQuery_graphql.Internal.convertVariables(param), {
                        fetchPolicy: param$1,
...
function $$fetch(environment, variables, onResult, networkCacheConfig, fetchPolicy, param) {
  Hooks.fetchQuery(environment, SearchProductCategoryQuery_graphql.node, SearchProductCategoryQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
        ...
        next: (function (res) {
            return Curry._1(onResult, {
                        TAG: /* Ok */0,
                        _0: SearchProductCategoryQuery_graphql.Internal.convertResponse(res)
                      });
          }),
        error: (function (err) {
            return Curry._1(onResult, {
...
function fetchPromised(environment, variables, networkCacheConfig, fetchPolicy, param) {
  var __x = Hooks.fetchQuery(environment, SearchProductCategoryQuery_graphql.node, SearchProductCategoryQuery_graphql.Internal.convertVariables(variables), {
          networkCacheConfig: networkCacheConfig,
          fetchPolicy: RescriptRelay.mapFetchQueryFetchPolicy(fetchPolicy)
        }).toPromise();
  return __x.then(function (res) {
              return Promise.resolve(SearchProductCategoryQuery_graphql.Internal.convertResponse(res));
            });
}

function usePreloaded(queryRef, param) {
  var data = Hooks.usePreloadedQuery(SearchProductCategoryQuery_graphql.node, queryRef);
  return RescriptRelay_Internal.internal_useConvertedValue(SearchProductCategoryQuery_graphql.Internal.convertResponse, data);
}

function retain(environment, variables) {
  var operationDescriptor = RelayRuntime.createOperationDescriptor(SearchProductCategoryQuery_graphql.node, SearchProductCategoryQuery_graphql.Internal.convertVariables(variables));
  return environment.retain(operationDescriptor);
}

var Query_makeVariables = SearchProductCategoryQuery_graphql.Utils.makeVariables;
...
var defaultProductCategory = Js_dict.fromArray(displayCategory);
...
function Search_Product_Category$Skeleton(Props) {
...
Caml_module.update_mod({
      ...
      make: Search_Product_Category$Skeleton
    });
...
function Search_Product_Category$Category(Props) {
...
Caml_module.update_mod({
      ...
      make: Search_Product_Category$Category
    });

function Search_Product_Category$Selection(Props) {
  var parentId = Props.parentId;
  var control = Props.control;
  var name = Props.name;
...
Caml_module.update_mod({
      ...
      make: Search_Product_Category$Selection
    });

function Search_Product_Category(Props) {
  var control = Props.control;
  var name = Props.name;
...
var make = Search_Product_Category;
...
/* displayCategory Not a pure module */
