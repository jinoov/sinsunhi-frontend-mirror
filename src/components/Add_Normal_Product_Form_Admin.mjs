...
var Mutation_productNotationInformationType_decode = AddNormalProductFormAdminMutation_graphql.Utils.productNotationInformationType_decode;

var Mutation_productNotationInformationType_fromString = AddNormalProductFormAdminMutation_graphql.Utils.productNotationInformationType_fromString;

var Mutation_productSalesType_decode = AddNormalProductFormAdminMutation_graphql.Utils.productSalesType_decode;

var Mutation_productSalesType_fromString = AddNormalProductFormAdminMutation_graphql.Utils.productSalesType_fromString;
      ...
      if (buyerProductName.TAG === /* Ok */0) {
        ...
        if (basePrice.TAG === /* Ok */0) {
              ...
              if (displayCategories.TAG === /* Ok */0) {
                ...
                if (operationStatus.TAG === /* Ok */0) {
                  ...
                  return {
                          TAG: /* Error */1,
                          _0: {
                            path: "." + ("product-tax" + e$10.path),
                            message: e$10.message,
                            value: e$10.value
                          }
                        };
                }
                var e$11 = operationStatus._0;
                return {
                        TAG: /* Error */1,
                        _0: {
                          path: "." + ("product-operation-status" + e$11.path),
                          message: e$11.message,
                          value: e$11.value
                        }
                      };
              }
              var e$12 = displayCategories._0;
              return {
                      TAG: /* Error */1,
                      _0: {
                        path: "." + ("display-categories" + e$12.path),
                        message: e$12.message,
                        value: e$12.value
                      }
                    };
            }
            var e$13 = productCategory._0;
            return {
                    TAG: /* Error */1,
                    _0: {
                      path: "." + ("product-category" + e$13.path),
          ...
          return {
                  TAG: /* Error */1,
                  _0: {
                    path: "." + ("origin" + e$14.path),
                    message: e$14.message,
                    value: e$14.value
                  }
                };
        }
        var e$15 = basePrice._0;
        return {
                TAG: /* Error */1,
                _0: {
                  path: "." + ("base-price" + e$15.path),
                  message: e$15.message,
                  value: e$15.value
                }
              };
      }
      var e$16 = buyerProductName._0;
      return {
              TAG: /* Error */1,
              _0: {
                path: "." + ("buyer-product-name" + e$16.path),
                message: e$16.message,
                value: e$16.value
              }
            };
    }
    var e$17 = producerProductName._0;
    return {
            TAG: /* Error */1,
            _0: {
              path: "." + ("producer-product-name" + e$17.path),
              message: e$17.message,
              value: e$17.value
            }
          };
  }
  var e$18 = producerName._0;
  return {
          TAG: /* Error */1,
          _0: {
            path: "." + ("producer-name" + e$18.path),
...
function Add_Normal_Product_Form_Admin$NotationTypeInput(props) {
  var name = props.name;
  var match = ReactHookForm$1.useFormContext({
        mode: "onChange"
      }, undefined);
              ...
              className: "flex flex-col gap-2 max-w-md w-1/3"
                  ...
                  render: (function (param) {
                      ...
                      return React.createElement("div", undefined, React.createElement(Select_Product_NotationType_Admin.Notation.make, {
                                      ...
                                      onChange: (function (s) {
                                          Curry._1(onChange, Curry._1(ReactHookForm.Controller.OnChangeArg.value, Select_Product_NotationType_Admin.Notation.status_encode(s)));
                                        }),
                                      forwardRef: match.ref
                                    }), React.createElement(ErrorMessage.ErrorMessage, {
                                      name: name,
...
var NotationTypeInput = {
  make: Add_Normal_Product_Form_Admin$NotationTypeInput
};
...
function Add_Normal_Product_Form_Admin$QuotationTypeInput(props) {
  var name = props.name;
  var match = ReactHookForm$1.useFormContext({
        mode: "onChange"
      }, undefined);
  ...
  return React.createElement("div", {
              className: "flex flex-col gap-2 max-w-md w-1/3"
                  ...
                  defaultValue: Caml_option.some(null),
...
var QuotationTypeInput = {
  make: Add_Normal_Product_Form_Admin$QuotationTypeInput
};
...
function makeNormalProductVariables(form) {
  ...
  var match$2 = form.operationStatus;
  var tmp$1;
  switch (match$2) {
    case /* SALE */0 :
        tmp$1 = "SALE";
  ...
  var tmp$3 = Belt_Option.keep(form.notice, (function (str) {
          return str !== "";
        }));
  if (tmp$3 !== undefined) {
    tmp$2.notice = tmp$3;
  }
  var tmp$4 = ProductForm.makeNoticeDate(form.noticeEndAt, (function (prim) {
          return EndOfDay(prim);
        }));
  if (tmp$4 !== undefined) {
    tmp$2.noticeEndAt = tmp$4;
  }
  var tmp$5 = ProductForm.makeNoticeDate(form.noticeStartAt, (function (prim) {
          return StartOfDay(prim);
        }));
  if (tmp$5 !== undefined) {
    tmp$2.noticeStartAt = tmp$5;
  }
  var tmp$6 = Belt_Option.keep(form.documentURL, (function (str) {
          return str !== "";
        }));
  if (tmp$6 !== undefined) {
    tmp$2.salesDocument = tmp$6;
  }
  if (tmp !== undefined) {
    tmp$2.salesType = Caml_option.valFromOption(tmp);
  }
  return tmp$2;
}
...
function Add_Normal_Product_Form_Admin(props) {
  ...
  var setShowNormalSuccess = match$3[1];
      ...
      Curry.app(normalMutate, [
            ...
            (function (param, param$1) {
                ...
                if (typeof createProduct === "object") {
                  var variant = createProduct.NAME;
                  if (variant === "Error") {
                    var message = createProduct.VAL.message;
                  ...
                  if (variant === "CreateProductResult") {
                    var product = createProduct.VAL.product;
                    return setShowNormalSuccess(function (param) {
                                return /* Show */{
                                        _0: product.id
                                      };
                              });
            ...
            undefined,
            undefined,
            makeNormalProductVariables(data$1._0),
            undefined,
            undefined
          ]);
      return ;
                            ...
                            className: "divide-y text-sm"
                                ...
                                className: "py-6 flex flex-col space-y-6"
                                    ...
                                    className: "flex gap-2"
                                        ...
                                        name: "origin"
                                      }), React.createElement(Add_Normal_Product_Form_Admin$NotationTypeInput, {
                                ...
                                className: "py-6 flex space-y-6"
                                    ...
                                    name: quotable
                                  }), React.createElement(Add_Normal_Product_Form_Admin$QuotationTypeInput, {
                                    name: "sales-type",
