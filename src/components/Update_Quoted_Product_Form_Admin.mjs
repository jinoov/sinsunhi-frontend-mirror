...
import * as UpdateQuotedProductFormAdminFragment_graphql from "../__generated__/UpdateQuotedProductFormAdminFragment_graphql.mjs";
...
function useOpt(opt_fRef) {
  ...
  return RescriptRelay_Internal.internal_useConvertedValue((function (rawFragment) {
                if (rawFragment !== undefined) {
                  return UpdateQuotedProductFormAdminFragment_graphql.Internal.convertFragment(rawFragment);
                }
                
              }), data);
}

var Fragment_displayCategoryType_decode = UpdateQuotedProductFormAdminFragment_graphql.Utils.displayCategoryType_decode;

var Fragment_displayCategoryType_fromString = UpdateQuotedProductFormAdminFragment_graphql.Utils.displayCategoryType_fromString;

var Fragment_productSalesType_decode = UpdateQuotedProductFormAdminFragment_graphql.Utils.productSalesType_decode;

var Fragment_productSalesType_fromString = UpdateQuotedProductFormAdminFragment_graphql.Utils.productSalesType_fromString;

var Fragment_productStatus_decode = UpdateQuotedProductFormAdminFragment_graphql.Utils.productStatus_decode;

var Fragment_productStatus_fromString = UpdateQuotedProductFormAdminFragment_graphql.Utils.productStatus_fromString;
...
function commitMutation(environment, variables, optimisticUpdater, optimisticResponse, updater, onCompleted, onError, uploadables, param) {
  return RelayRuntime.commitMutation(environment, {
              mutation: UpdateQuotedProductFormAdminMutation_graphql.node,
              variables: UpdateQuotedProductFormAdminMutation_graphql.Internal.convertVariables(variables),
              onCompleted: (function (res, err) {
                  if (onCompleted !== undefined) {
                    return Curry._2(onCompleted, UpdateQuotedProductFormAdminMutation_graphql.Internal.convertResponse(res), (err == null) ? undefined : Caml_option.some(err));
                  }
...
var Mutation_errorCode_decode = UpdateQuotedProductFormAdminMutation_graphql.Utils.errorCode_decode;

var Mutation_errorCode_fromString = UpdateQuotedProductFormAdminMutation_graphql.Utils.errorCode_fromString;

var Mutation_productSalesType_decode = UpdateQuotedProductFormAdminMutation_graphql.Utils.productSalesType_decode;

var Mutation_productSalesType_fromString = UpdateQuotedProductFormAdminMutation_graphql.Utils.productSalesType_fromString;

var Mutation_productStatus_decode = UpdateQuotedProductFormAdminMutation_graphql.Utils.productStatus_decode;
        ...
        if (productCategory.TAG === /* Ok */0) {
          ...
          if (displayCategories.TAG === /* Ok */0) {
            ...
            if (operationStatus.TAG === /* Ok */0) {
              var grade = Spice.stringFromJson(Belt_Option.getWithDefault(Js_dict.get(dict$1, "product-grade"), null));
              if (grade.TAG === /* Ok */0) {
...
function Update_Quoted_Product_Form_Admin$ReadOnlyProducer(Props) {
...
var ReadOnlyProducer = {
  make: Update_Quoted_Product_Form_Admin$ReadOnlyProducer
};

function Update_Quoted_Product_Form_Admin$Category(Props) {
  var name = Props.name;
...
var Category = {
  make: Update_Quoted_Product_Form_Admin$Category
};

function Update_Quoted_Product_Form_Admin$DisplayCategoryInput(Props) {
  var name = Props.name;
...
var DisplayCategoryInput = {
  make: Update_Quoted_Product_Form_Admin$DisplayCategoryInput
};

function Update_Quoted_Product_Form_Admin$ProductNameInputs(Props) {
...
var ProductNameInputs = {
  make: Update_Quoted_Product_Form_Admin$ProductNameInputs
};

function Update_Quoted_Product_Form_Admin$ReadOnlyProductId(Props) {
...
var ReadOnlyProductId = {
  make: Update_Quoted_Product_Form_Admin$ReadOnlyProductId
};

function Update_Quoted_Product_Form_Admin$OperationStatusInput(Props) {
  var name = Props.name;
...
var OperationStatusInput = {
  make: Update_Quoted_Product_Form_Admin$OperationStatusInput
};

function Update_Quoted_Product_Form_Admin$OriginInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var disabled = Props.disabled;
  var match = ReactHookForm$1.useFormContext({
...
var OriginInput = {
  make: Update_Quoted_Product_Form_Admin$OriginInput
};

function Update_Quoted_Product_Form_Admin$QuotationTypeInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var match = ReactHookForm$1.useFormContext({
        mode: "onChange"
  ...
  var tmp$1 = Belt_Option.map(defaultValue, Select_Product_QuotationType_Admin.QuotationType.t_encode);
  if (tmp$1 !== undefined) {
    tmp.defaultValue = Caml_option.valFromOption(tmp$1);
  }
  return React.createElement("div", {
...
var QuotationTypeInput = {
  make: Update_Quoted_Product_Form_Admin$QuotationTypeInput
};

function Update_Quoted_Product_Form_Admin$GradeInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var disabled = Props.disabled;
  var match = ReactHookForm$1.useFormContext({
...
var GradeInput = {
  make: Update_Quoted_Product_Form_Admin$GradeInput
};

function Update_Quoted_Product_Form_Admin$NoticeAndDateInput$DateInput(Props) {
  var name = Props.name;
...
var DateInput = {
  make: Update_Quoted_Product_Form_Admin$NoticeAndDateInput$DateInput
};

function Update_Quoted_Product_Form_Admin$NoticeAndDateInput(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("div", {
                  ...
                  className: "flex flex-col gap-2"
                    ...
                    }, React.createElement(Update_Quoted_Product_Form_Admin$NoticeAndDateInput$DateInput, tmp$1), React.createElement("span", {
                          className: "flex items-center"
                        }, "~"), React.createElement(Update_Quoted_Product_Form_Admin$NoticeAndDateInput$DateInput, tmp$2))));
}

var NoticeAndDateInput = {
  DateInput: DateInput,
  make: Update_Quoted_Product_Form_Admin$NoticeAndDateInput
};

function Update_Quoted_Product_Form_Admin$ThumbnailUploadInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var disabled = Props.disabled;
  var match = ReactHookForm$1.useFormContext({
...
var ThumbnailUploadInput = {
  make: Update_Quoted_Product_Form_Admin$ThumbnailUploadInput
};

function Update_Quoted_Product_Form_Admin$SalesDocumentURLInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var disabled = Props.disabled;
  var match = ReactHookForm$1.useFormContext({
...
var SalesDocumentURLInput = {
  make: Update_Quoted_Product_Form_Admin$SalesDocumentURLInput
};

function Update_Quoted_Product_Form_Admin$EditorInput(Props) {
  var name = Props.name;
  var defaultValue = Props.defaultValue;
  var disabled = Props.disabled;
  var match = ReactHookForm$1.useFormContext({
...
var EditorInput = {
  make: Update_Quoted_Product_Form_Admin$EditorInput
};
...
function Update_Quoted_Product_Form_Admin(Props) {
  ...
  var isQuotedlMutating = match[1];
  var quotedlMutate = match[0];
    ...
    if (data$1.TAG === /* Ok */0) {
      Curry.app(quotedlMutate, [
            ...
            (function (param, param$1) {
                var updateQuotedProduct = param.updateQuotedProduct;
                if (typeof updateQuotedProduct === "object") {
                  var variant = updateQuotedProduct.NAME;
                  if (variant === "UpdateQuotedProductResult") {
                    return setShowUpdateSuccess(function (param) {
                                return /* Show */0;
                              });
                  }
                  if (variant === "Error") {
                    var message = updateQuotedProduct.VAL.message;
            ...
            undefined,
            undefined,
            makeQuotedProductVariables(product.id, data$1._0),
            undefined,
            undefined
          ]);
      return ;
                  ...
                  onSubmit: methods.handleSubmit(onSubmit)
                      ...
                      className: "p-7 mx-4 bg-white rounded-b-md"
                          ...
                          className: "divide-y text-sm"
                            ...
                            }, React.createElement(Update_Quoted_Product_Form_Admin$ReadOnlyProducer, {
                                  value: producerToReactSelected(product.producer)
                                }), React.createElement(Update_Quoted_Product_Form_Admin$Category, {
                                  name: "product-category"
                                }), React.createElement(Update_Quoted_Product_Form_Admin$DisplayCategoryInput, {
                                  name: "display-categories",
                                  disabled: disabled
                                })), React.createElement("div", {
                              className: "flex flex-col space-y-6 py-6"
                            }, React.createElement(Update_Quoted_Product_Form_Admin$ProductNameInputs, {
                                  producerProductName: "producer-product-name",
                                  producerProductNameDefaultValue: product.name,
                                  buyerProductName: "buyer-product-name",
                                  buyerProductNameDefaultValue: product.displayName,
                                  disabled: disabled
                                }), React.createElement(Update_Quoted_Product_Form_Admin$ReadOnlyProductId, {
                                  productId: String(product.productId)
                                })), React.createElement("div", {
                              className: "py-6 flex flex-col space-y-6"
                            }, React.createElement("div", {
                                  className: "flex gap-2"
                                }, React.createElement(Update_Quoted_Product_Form_Admin$OperationStatusInput, {
                                      name: "product-operation-status",
                                      defaultValue: decodeStatus(product.status),
                                      disabled: disabled
                                    }), React.createElement(Update_Quoted_Product_Form_Admin$QuotationTypeInput, {
                                      name: "sales-type",
                                      defaultValue: decodeSalesType(product.salesType)
                                    })), React.createElement("div", {
                                  className: "flex gap-2 text-sm"
                                }, React.createElement(Update_Quoted_Product_Form_Admin$OriginInput, {
                                      name: "origin",
                                      defaultValue: product.origin,
                                      disabled: disabled
                                    }), React.createElement(Update_Quoted_Product_Form_Admin$GradeInput, {
                                      name: "product-grade",
                      ...
                      className: "p-7 mt-4 mx-4 mb-7 bg-white rounded shadow-gl"
                          ...
                          className: "text-sm py-6 flex flex-col space-y-6"
                        }, React.createElement(Update_Quoted_Product_Form_Admin$NoticeAndDateInput, {
                              noticeName: "notice",
                              ...
                              disabled: disabled
                            }), React.createElement(Update_Quoted_Product_Form_Admin$ThumbnailUploadInput, {
                              name: "thumbnail",
                              defaultValue: toImage(product.image),
                              disabled: disabled
                            }), React.createElement(Update_Quoted_Product_Form_Admin$SalesDocumentURLInput, {
                              name: "document-url",
                              defaultValue: product.salesDocument,
                              disabled: disabled
                            }), React.createElement(Update_Quoted_Product_Form_Admin$EditorInput, {
...
var make = Update_Quoted_Product_Form_Admin;
