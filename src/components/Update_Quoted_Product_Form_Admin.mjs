...
function Update_Quoted_Product_Form_Admin$QuotationTypeInput(props) {
  ...
  return React.createElement("div", {
              className: "flex flex-col gap-2 max-w-md w-1/3"
                  ...
                  defaultValue: Belt_Option.map(props.defaultValue, Select_Product_QuotationType_Admin.QuotationType.t_encode),
                  rules: Caml_option.some(ReactHookForm.Rules.make(true, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined))
                }));
}
...
function Update_Quoted_Product_Form_Admin$GradeInput(props) {
  ...
  return React.createElement("div", {
              className: "flex flex-col gap-2 max-w-md w-1/3"
                  ...
                  className: getTextInputStyle(props.disabled),
                  id: grade.name,
                  name: grade.name,
                  placeholder: "등급 입력",
                  onBlur: grade.onBlur,
...
function Update_Quoted_Product_Form_Admin$NoticeAndDateInput(props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("div", {
                  ...
                  className: "flex flex-col gap-2"
                    ...
                    }, React.createElement(Update_Quoted_Product_Form_Admin$NoticeAndDateInput$DateInput, {
                          name: noticeFromName,
                          minDate: "2021-01-01",
