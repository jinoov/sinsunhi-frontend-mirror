...
function Update_Quoted_Product_Form_Admin$ReadOnlyCategory(Props) {
  var name = Props.name;
...
var ReadOnlyCategory = {
  make: Update_Quoted_Product_Form_Admin$ReadOnlyCategory
};
                      ...
                      className: "p-7 mx-4 bg-white rounded-b-md"
                          ...
                          className: "divide-y text-sm"
                              ...
                              className: "flex flex-col space-y-6 py-6"
                                ...
                                }), React.createElement(Update_Quoted_Product_Form_Admin$ReadOnlyCategory, {
