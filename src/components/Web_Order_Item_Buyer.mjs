...
function Web_Order_Item_Buyer$PlaceHolder$PC(props) {
  ...
  return React$1.createElement(React$1.Fragment, undefined, React.createElementWithKey(Header_Buyer.PC_Old.make, {}, router.asPath), React$1.createElement("main", {
                  className: "flex flex-col gap-5 px-[16%] py-20 bg-surface"
                    ...
                    }, "주문·결제"), React$1.createElement("div", {
                      className: "flex flex-col xl:flex-row gap-5"
                          ...
                          className: "w-3/5 flex flex-col gap-5 min-w-[550px]"
                            ...
                            }, React$1.createElement(Web_Order_Product_Info_Buyer.PlaceHolder.PC.make, {}), React$1.createElement("div", {
                                  className: "h-px bg-border-default-L2"
                                }), React$1.createElement(Web_Order_Orderer_Info_Buyer.PlaceHolder.make, {
                                  deviceType: props.deviceType
                                })), React$1.createElement(Web_Order_Delivery_Method_Selection_Buyer.PlaceHoder.PC.make, {})), React$1.createElement("aside", {
                          className: "w-2/5"
                        }, React$1.createElement(Web_Order_Payment_Info_Buyer.PlaceHolder.PC.make, {})))), React$1.createElement(Footer_Buyer.PC.make, {}));
}
                  ...
                  className: "flex flex-col gap-3 bg-surface"
                      ...
                      className: "flex flex-col gap-4"
                          ...
                          className: "w-full flex flex-col gap-5"
                              ...
                              className: "flex flex-col gap-7 p-7 bg-white"
                            }, React$1.createElement(Web_Order_Product_Info_Buyer.PlaceHolder.MO.make, {}), React$1.createElement("div", {
                                  className: "h-px bg-border-default-L2"
                                }), React$1.createElement(Web_Order_Orderer_Info_Buyer.PlaceHolder.make, {
                                  deviceType: props.deviceType
                                })), React$1.createElement(Web_Order_Delivery_Method_Selection_Buyer.PlaceHoder.MO.make, {})), React$1.createElement("aside", {
                          className: "w-full"
                        }, React$1.createElement(Web_Order_Payment_Info_Buyer.PlaceHolder.MO.make, {})))), React$1.createElement(Footer_Buyer.MO.make, {}));
}
...
function Web_Order_Item_Buyer$PlaceHolder(props) {
  ...
  switch (deviceType) {
    case /* Unknown */0 :
        return null;
    case /* PC */1 :
        return React$1.createElement(Web_Order_Item_Buyer$PlaceHolder$PC, {
                    deviceType: deviceType
                  });
    case /* Mobile */2 :
        return React$1.createElement(Web_Order_Item_Buyer$PlaceHolder$MO, {
                    deviceType: deviceType
                  });
              ...
              className: "flex flex-col gap-5 px-[16%] py-20 bg-surface"
                  ...
                  className: "flex flex-row gap-5"
                      ...
                      className: "w-2/3 flex flex-col gap-5 min-w-[550px]"
                          ...
                          className: "flex flex-col gap-7 p-7 bg-white"
                        }, React$1.createElement(Web_Order_Product_Info_Buyer.PC.make, {
                              productInfos: productInfos
                            }), React$1.createElement(Web_Order_Orderer_Info_Buyer.make, {
                              deviceType: deviceType
                          ...
                          className: "flex flex-col gap-5 p-7 bg-white rounded-sm"
                            ...
                            }, "배송 방식 선택", React$1.createElement(Web_Order_Util_Component.Tooltip.PC.make, {
                                  children: "선택하신 배송 방식에 따라 배송비 부과 정책이 달라집니다.",
                                  className: "flex"
                                })), React$1.createElement(Web_Order_Delivery_Method_Selection_Buyer.make, {
                              isSameCourierAvailable: props.isSameCourierAvailable,
                              isCourierAvailable: props.firstIsCourierAvailable,
                              prefix: formNames.name,
                              deviceType: deviceType
                            }), React$1.createElement(Web_Order_Delivery_Form.make, {
                              watchValue: props.watchValue,
                              prefix: formNames.name,
                              deviceType: deviceType
                            }))), React$1.createElement("aside", {
                      className: "w-1/3 min-h-full relative bottom-0"
                    }, React$1.createElement(Web_Order_Payment_Info_Buyer.make, {
                          prefix: formNames.name,
                          productInfos: productInfos,
                          deviceType: deviceType
                        }))));
              ...
              className: "flex flex-col gap-5 bg-surface"
                  ...
                  className: "flex flex-col gap-4"
                      ...
                      className: "w-full flex flex-col gap-5"
                        ...
                        }, React$1.createElement(Web_Order_Product_Info_Buyer.MO.make, {
                              productInfos: productInfos
                            }), React$1.createElement("div", {
                          ...
                          className: "flex flex-col gap-5 p-5 pb-7 bg-white rounded-sm"
                            ...
                            }, "배송 방식 선택", React$1.createElement(Web_Order_Util_Component.Tooltip.Mobile.make, {
                                  children: "선택하신 배송 방식에 따라 배송비 부과 정책이 달라집니다.",
                                  className: "flex"
                                })), React$1.createElement(Web_Order_Delivery_Method_Selection_Buyer.make, {
                              isSameCourierAvailable: props.isSameCourierAvailable,
...
function Web_Order_Item_Buyer(props) {
  ...
  var temp = Belt_Array.map(Belt_SetInt.toArray(Belt_SetInt.fromArray(props.productNos)), (function (a) {
          return use$1({
                      number: a
  ...
  switch (deviceType) {
    case /* Unknown */0 :
        return null;
    case /* PC */1 :
        return React$1.createElement(React$1.Fragment, undefined, React.createElementWithKey(Header_Buyer.PC_Old.make, {}, router.asPath), React$1.createElement(Web_Order_Item_Buyer$PC, {
                        productInfos: productInfos,
    ...
    case /* Mobile */2 :
        return React$1.createElement(React$1.Fragment, undefined, React.createElementWithKey(Header_Buyer.Mobile.make, {}, router.asPath), React$1.createElement(Web_Order_Item_Buyer$MO, {
                        productInfos: productInfos,
                        firstIsCourierAvailable: firstIsCourierAvailable,
                        isSameCourierAvailable: isSameCourierAvailable,
                        formNames: formNames,
