...
function Orders_Cancel_Dialog_Admin(props) {
  ...
  return React$1.createElement(Dialog.make, {
              isShow: props.isShowCancelConfirm,
              children: React$1.createElement("div", {
                    className: "text-black-gl text-center whitespace-pre-wrap w-full"
                        ...
                        className: "flex justify-between items-center"
                          ...
                          }, "주문 취소"), React$1.createElement("button", {
                            type: "button",
                            onClick: (function (param) {
                                reset(undefined);
                              })
                        ...
                        className: "mt-7 flex justify-between items-center"
                          ...
                          }, "취소할 주문 수"), React$1.createElement("span", {
                            className: "text-text-L1 text-sm font-bold"
                          }, "" + String(selectedOrders.length) + "개 선택됨")), React$1.createElement("div", {
                        className: "my-5 bg-[#EDEFF2] h-px w-full"
                      }), React$1.createElement("div", {
                        className: "flex w-full flex-col gap-2 items-start"
                      }, React$1.createElement("span", {
                            className: "text-text-L1 text-sm"
                          }, "취소사유(필수)"), React$1.createElement("div", {
                            className: "w-full"
                                ...
                                children: null
                                    ...
                                    children: React$1.createElement("div", {
                                          className: "w-full h-13 p-3 flex items-center justify-between border rounded-xl"
                                            ...
                                            }, Belt_Option.mapWithDefault(reason, "선택해주세요", toString)), React$1.createElement(IconArrowSelect.make, {
                                              height: "20",
                                              width: "20",
                                              fill: "#121212"
                                            })),
                                    ...
                                    children: React$1.createElement(Orders_Cancel_Dialog_Admin$Scroll, {
                                          children: Belt_Array.map([
                                                ...
                                                "ETC"
                                                  ...
                                                  return React.createElementWithKey(Orders_Cancel_Dialog_Admin$Item, {
                                                              reason: reason,
                                                              setReason: setReason
                                                            }, toString(reason));
                                                }))
                            ...
                            className: "mt-5 flex flex-col gap-2 items-start w-full"
                                ...
                                className: "text-text-L1 text-sm"
                              }, "취소상세사유(선택)"), React$1.createElement("textarea", {
