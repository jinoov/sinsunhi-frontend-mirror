...
function Search_Product_Buyer(Props) {
  ...
  var partial_arg$1 = Curry._1(form.handleChange, /* ProductName */0);
  return React.createElement(FeatureFlagWrapper.make, {
              children: React.createElement("div", {
                    className: "sm:mt-4 bg-white"
                  }, React.createElement(FormulaComponents.TextHeadline, {
                        className: "mb-7 mt-10 ml-[50px] hidden lg:block",
                        size: "lg",
                        weight: "bold",
                        children: "단품 확인"
                      }), React.createElement("form", {
                        className: "py-7 px-4 lg:py-0 lg:px-[50px]",
                        onSubmit: handleOnSubmit
                      }, React.createElement("div", {
                            className: "py-3 flex flex-col text-sm bg-[#FAFBFC] rounded-xl"
                          }, React.createElement("div", {
                                className: "flex flex-col lg:flex-row"
                              }, React.createElement("div", {
                                    className: "w-32 font-bold pl-3 whitespace-nowrap lg:pl-7 lg:pt-3"
