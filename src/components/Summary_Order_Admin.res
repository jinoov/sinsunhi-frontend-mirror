...
module FormFields = Query_Order_Form_Admin.FormFields
module Form = Query_Order_Form_Admin.Form
...
let make = () => {
  ...
  let form: Form.api = Form.use(
    ...
    ~onSubmit,
    ~initialState=Query_Order_Form_Admin.initialState,
    ~schema={
  ...
  <div className=%twc("py-3 px-7 pb-7 mt-4 mx-4 shadow-gl bg-white rounded")>
    <StatusFilter />
