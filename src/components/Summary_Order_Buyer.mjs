...
var StatusFilter = {
  make: Summary_Order_Buyer$StatusFilter
};

function Summary_Order_Buyer(Props) {
  ...
  var onSubmit = function (param) {
    ...
    var orderProductNo = Query_Order_Form_Buyer.FormFields.get(state.values, /* OrderProductNo */0);
    var productId = Query_Order_Form_Buyer.FormFields.get(state.values, /* ProductId */1);
    var ordererName = Query_Order_Form_Buyer.FormFields.get(state.values, /* OrdererName */2);
    var receiverName = Query_Order_Form_Buyer.FormFields.get(state.values, /* ReceiverName */3);
    var sku = Query_Order_Form_Buyer.FormFields.get(state.values, /* Sku */4);
  ...
  var form = Curry._7(Query_Order_Form_Buyer.Form.use, Query_Order_Form_Buyer.initialState, /* Schema */{
        _0: Belt_Array.concatMany([
              Curry._4(Query_Order_Form_Buyer.Form.ReSchema.Validation.regExp, "최소 2글자를 입력해주세요.", "^(?:.{2,}|)$", undefined, /* OrdererName */2),
              Curry._4(Query_Order_Form_Buyer.Form.ReSchema.Validation.regExp, "최소 2글자를 입력해주세요.", "^(?:.{2,}|)$", undefined, /* ReceiverName */3)
            ])
