...
function Add_Matching_Product_Form_Admin$AutoStatusCheckbox(Props) {
  var name = Props.name;
  var match = ReactHookForm$1.useFormContext({
        mode: "onChange"
      }, undefined);
...
var AutoStatusCheckbox = {
  make: Add_Matching_Product_Form_Admin$AutoStatusCheckbox
};
                        ...
                        className: "p-7 mx-4 bg-white rounded-b-md"
                            ...
                            className: "divide-y text-sm"
                                ...
                                className: "py-6 flex flex-col space-y-6"
                                    ...
                                    toName: "shipment-to"
                                  }), React.createElement(Add_Matching_Product_Form_Admin$AutoStatusCheckbox, {
                                    name: "auto-status"
                                  })))), React.createElement("section", {
