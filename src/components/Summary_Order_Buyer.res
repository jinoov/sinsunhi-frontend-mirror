module StatusFilter = {
  ...
  let make = () => {
    let oldUI =
      <div className=%twc("py-4 lg:px-5")>
        ...
        <ol
          ...
          <Status.Total />
          <Status.Item kind=DEPOSIT_PENDING />
    ...
    <FeatureFlagWrapper featureFlag=#HOME_UI_UX fallback=oldUI>
      <div className=%twc("py-7 lg:px-5")>
        <h3 className=%twc("font-bold text-[26px] whitespace-nowrap")>
          {`주문내역`->React.string}
        </h3>
        <ol
          className=%twc(
...
module FormFields = Query_Order_Form_Buyer.FormFields
module Form = Query_Order_Form_Buyer.Form
...
let make = () => {
  ...
  let form: Form.api = Form.use(
    ...
    ~onSubmit,
    ~initialState=Query_Order_Form_Buyer.initialState,
    ~schema={
          ...
          <div className=%twc("flex flex-col lg:flex-row")>
            ...
            <div className=%twc("flex-1 px-3 lg:px-0")>
              <div className=%twc("flex mt-2")>
                <div
                  className=%twc(
                    "flex-1 flex flex-col mr-2 sm:w-64 sm:flex-initial sm:flex-row sm:items-center sm:mr-16"
                  )>
                  ...
                  <Input
                    ...
                    onChange={FormFields.OrdererName
                    ->form.handleChange
                ...
                <div
                  ...
                  <Input
                    ...
                    onChange={FormFields.ReceiverName
                    ->form.handleChange
                    ->ReForm.Helpers.handleChange}
  ...
  <FeatureFlagWrapper featureFlag=#HOME_UI_UX fallback=oldUI>
    <div
      className=%twc(
        "py-3 px-4 lg:px-[30px] pb-7 shadow-gl lg:shadow-none sm:mt-4 lg:mt-0 bg-white w-full"
      )>
      <StatusFilter />
      <form onSubmit={handleOnSubmit} className=%twc("lg:px-4")>
        <div className=%twc("py-3 flex flex-col text-sm bg-gray-gl rounded-xl")>
        ...
        <div className=%twc("flex justify-end mt-5")>
          <span className=%twc("w-20 h-11 flex mr-2")>
            <input
              type_="button"
              className=%twc("btn-level6")
