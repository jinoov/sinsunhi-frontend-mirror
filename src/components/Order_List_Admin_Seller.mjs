...
function Order_List_Admin_Seller$Loading(props) {
  return React$1.createElement("div", {
              className: "w-full overflow-x-scroll"
                  ...
                  className: "min-w-max text-sm divide-y divide-gray-100"
                }, React$1.createElement(Order_List_Admin_Seller$Header, {}), React$1.createElement("ol", {
                      className: "divide-y divide-gray-100 lg:list-height-admin-seller lg:overflow-y-scroll"
                            ...
                            return React$1.createElement(Order_Admin_Seller.Item.Loading.make, {});
                          })))));
}
...
function Order_List_Admin_Seller(props) {
  ...
  if (typeof status === "number") {
    return React$1.createElement(Order_List_Admin_Seller$Loading, {});
  }
  if (status.TAG !== /* Loaded */0) {
    return React$1.createElement(ErrorPanel.make, {
                error: status._0,
                renderOnRetry: Caml_option.some(React$1.createElement(Order_List_Admin_Seller$Loading, {}))
              });
  }
  ...
  if (orders$p$2.TAG === /* Ok */0) {
    ...
    tmp = React$1.createElement("ol", {
          className: "divide-y divide-gray-100 lg:list-height-admin-seller lg:overflow-y-scroll"
                  ...
                  return React.createElementWithKey(Order_Admin_Seller.make, {
                              order: order,
                              check: check,
  ...
  return React$1.createElement(React$1.Fragment, undefined, React$1.createElement("div", {
                  className: "w-full overflow-x-scroll"
                      ...
                      className: "min-w-max text-sm divide-y divide-gray-100"
                    }, React$1.createElement(Order_List_Admin_Seller$Header, {
                          checked: isCheckAll,
